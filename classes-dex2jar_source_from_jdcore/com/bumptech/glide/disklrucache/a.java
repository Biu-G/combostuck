  ...
  implements Closeable
{
  ...
  public a(InputStream paramInputStream, int paramInt, Charset paramCharset)
  {
  ...
  public a(InputStream paramInputStream, Charset paramCharset)
  {
          ...
          else
          {
            localObject1 = new ByteArrayOutputStream(e - d + 80)
            {
              public String toString()
              {
                ...
                try
                {
                  String str = new String(buf, 0, i, a.a(a.this).name());
                  return str;
                }
