...
class d
{
  ...
  public d(List<UserSelectorArg> paramList)
  {
    if (paramList != null)
    {
    ...
    extends StructSerializer<d>
  {
      ...
      if (localObject1 == null)
      {
        ...
        while (paramJsonParser.getCurrentToken() == JsonToken.FIELD_NAME)
        {
          ...
          if ("users".equals(localObject2)) {
            localObject1 = (List)StoneSerializers.nullable(StoneSerializers.list(UserSelectorArg.a.a)).deserialize(paramJsonParser);
          } else {
            skipValue(paramJsonParser);
          }
        }
        localObject1 = new d((List)localObject1);
        if (!paramBoolean) {
      ...
      throws IOException, JsonGenerationException
    {
      ...
      if (a != null)
      {
        ...
        StoneSerializers.nullable(StoneSerializers.list(UserSelectorArg.a.a)).serialize(a, paramJsonGenerator);
      }
      if (!paramBoolean) {
