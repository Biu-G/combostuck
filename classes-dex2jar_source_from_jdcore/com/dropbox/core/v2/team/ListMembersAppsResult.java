...
public class ListMembersAppsResult
{
    ...
    extends StructSerializer<ListMembersAppsResult>
  {
    ...
    public ListMembersAppsResult a(JsonParser paramJsonParser, boolean paramBoolean)
      throws IOException, JsonParseException
    {
      ...
      if (localObject1 == null)
      {
        ...
        if (localList != null)
        {
          ...
          {
            localObject1 = new ListMembersAppsResult(localList, ((Boolean)localObject2).booleanValue(), (String)localObject1);
            if (!paramBoolean) {
    ...
    public void a(ListMembersAppsResult paramListMembersAppsResult, JsonGenerator paramJsonGenerator, boolean paramBoolean)
