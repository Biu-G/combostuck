...
class ListMembersDevicesArg
{
    ...
    extends StructSerializer<ListMembersDevicesArg>
  {
    ...
    public ListMembersDevicesArg a(JsonParser paramJsonParser, boolean paramBoolean)
      throws IOException, JsonParseException
    {
      ...
      if (localObject1 == null)
      {
        ...
        localObject1 = new ListMembersDevicesArg(str1, ((Boolean)localObject2).booleanValue(), ((Boolean)localObject1).booleanValue(), localBoolean.booleanValue());
        if (!paramBoolean) {
    ...
    public void a(ListMembersDevicesArg paramListMembersDevicesArg, JsonGenerator paramJsonGenerator, boolean paramBoolean)
