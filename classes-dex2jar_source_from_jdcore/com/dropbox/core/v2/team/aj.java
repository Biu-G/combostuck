...
class aj
{
  ...
  static class a
    extends StructSerializer<aj>
  {
    public static final a a = new a();
    
    a() {}
    
    public aj a(JsonParser paramJsonParser, boolean paramBoolean)
      throws IOException, JsonParseException
    {
      ...
      if (localObject1 == null)
      {
        ...
        if (localObject1 != null)
        {
          localObject1 = new aj((String)localObject1);
          if (!paramBoolean) {
    ...
    public void a(aj paramAj, JsonGenerator paramJsonGenerator, boolean paramBoolean)
