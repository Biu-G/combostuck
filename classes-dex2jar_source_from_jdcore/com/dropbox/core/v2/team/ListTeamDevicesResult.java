...
public class ListTeamDevicesResult
{
  ...
  public ListTeamDevicesResult(List<MemberDevices> paramList, boolean paramBoolean)
  {
    this(paramList, paramBoolean, null);
  }
  
  public ListTeamDevicesResult(List<MemberDevices> paramList, boolean paramBoolean, String paramString)
  {
    if (paramList != null)
    {
  ...
  public boolean equals(Object paramObject)
  {
    ...
    {
      paramObject = (ListTeamDevicesResult)paramObject;
  ...
  static class a
    extends StructSerializer<ListTeamDevicesResult>
  {
    public static final a a = new a();
    
    a() {}
    
    public ListTeamDevicesResult a(JsonParser paramJsonParser, boolean paramBoolean)
      throws IOException, JsonParseException
    {
      ...
      if (localObject1 == null)
      {
        ...
        if (localList != null)
        {
          ...
          {
            localObject1 = new ListTeamDevicesResult(localList, ((Boolean)localObject2).booleanValue(), (String)localObject1);
            if (!paramBoolean) {
    ...
    public void a(ListTeamDevicesResult paramListTeamDevicesResult, JsonGenerator paramJsonGenerator, boolean paramBoolean)
