...
class ai
{
  ...
  static class a
    extends StructSerializer<ai>
  {
    public static final a a = new a();
    
    a() {}
    
    public ai a(JsonParser paramJsonParser, boolean paramBoolean)
      throws IOException, JsonParseException
    {
      ...
      if (localObject1 == null)
      {
        ...
        localObject1 = new ai(((Long)localObject1).longValue());
        if (!paramBoolean) {
    ...
    public void a(ai paramAi, JsonGenerator paramJsonGenerator, boolean paramBoolean)
