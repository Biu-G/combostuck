...
public class MembersListResult
{
    ...
    extends StructSerializer<MembersListResult>
  {
    ...
    public MembersListResult a(JsonParser paramJsonParser, boolean paramBoolean)
      ...
      if (localObject1 == null)
      {
        ...
        while (paramJsonParser.getCurrentToken() == JsonToken.FIELD_NAME)
        {
          ...
          if ("members".equals(str)) {
            localList = (List)StoneSerializers.list(TeamMemberInfo.a.a).deserialize(paramJsonParser);
        ...
        if (localList != null)
        {
          if (localObject2 != null)
          {
            if (localObject1 != null)
            {
              localObject1 = new MembersListResult(localList, (String)localObject2, ((Boolean)localObject1).booleanValue());
              if (!paramBoolean) {
    ...
    public void a(MembersListResult paramMembersListResult, JsonGenerator paramJsonGenerator, boolean paramBoolean)
      throws IOException, JsonGenerationException
    {
      ...
      StoneSerializers.list(TeamMemberInfo.a.a).serialize(members, paramJsonGenerator);
