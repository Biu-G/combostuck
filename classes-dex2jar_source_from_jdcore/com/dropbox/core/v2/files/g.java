...
class g
{
  protected final List<ThumbnailArg> a;
  
  public g(List<ThumbnailArg> paramList)
  {
    if (paramList != null)
    {
      Iterator localIterator = paramList.iterator();
      while (localIterator.hasNext()) {
        if ((ThumbnailArg)localIterator.next() == null) {
    ...
    extends StructSerializer<g>
  {
      ...
      if (localObject1 == null)
      {
        ...
        while (paramJsonParser.getCurrentToken() == JsonToken.FIELD_NAME)
        {
          ...
          if ("entries".equals(localObject2)) {
            localObject1 = (List)StoneSerializers.list(ThumbnailArg.a.a).deserialize(paramJsonParser);
          } else {
        ...
        if (localObject1 != null)
        {
          localObject1 = new g((List)localObject1);
          if (!paramBoolean) {
      ...
      throws IOException, JsonGenerationException
    {
      ...
      StoneSerializers.list(ThumbnailArg.a.a).serialize(a, paramJsonGenerator);
      if (!paramBoolean) {
