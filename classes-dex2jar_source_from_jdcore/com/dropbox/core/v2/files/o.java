...
class o
{
  ...
  public o(List<UploadSessionFinishArg> paramList)
  {
    if (paramList != null)
    {
    ...
    extends StructSerializer<o>
  {
      ...
      if (localObject1 == null)
      {
        ...
        while (paramJsonParser.getCurrentToken() == JsonToken.FIELD_NAME)
        {
          ...
          if ("entries".equals(localObject2)) {
            localObject1 = (List)StoneSerializers.list(UploadSessionFinishArg.a.a).deserialize(paramJsonParser);
          } else {
        ...
        if (localObject1 != null)
        {
          localObject1 = new o((List)localObject1);
          if (!paramBoolean) {
      ...
      throws IOException, JsonGenerationException
    {
      ...
      StoneSerializers.list(UploadSessionFinishArg.a.a).serialize(a, paramJsonGenerator);
      if (!paramBoolean) {
