  ...
  extends FileOpsResult
{
    ...
    extends StructSerializer<RelocationResult>
  {
    ...
    public RelocationResult a(JsonParser paramJsonParser, boolean paramBoolean)
      throws IOException, JsonParseException
    {
      ...
      if (localObject1 == null)
      {
        ...
        if (localObject1 != null)
        {
          localObject1 = new RelocationResult((Metadata)localObject1);
          if (!paramBoolean) {
    ...
    public void a(RelocationResult paramRelocationResult, JsonGenerator paramJsonGenerator, boolean paramBoolean)
