...
public class DownloadZipResult
{
  ...
  public DownloadZipResult(FolderMetadata paramFolderMetadata)
  {
  ...
  public boolean equals(Object paramObject)
  {
    ...
    {
      paramObject = (DownloadZipResult)paramObject;
  ...
  static class a
    extends StructSerializer<DownloadZipResult>
  {
    public static final a a = new a();
    
    a() {}
    
    public DownloadZipResult a(JsonParser paramJsonParser, boolean paramBoolean)
      throws IOException, JsonParseException
    {
      ...
      if (localObject1 == null)
      {
        ...
        if (localObject1 != null)
        {
          localObject1 = new DownloadZipResult((FolderMetadata)localObject1);
          if (!paramBoolean) {
    ...
    public void a(DownloadZipResult paramDownloadZipResult, JsonGenerator paramJsonGenerator, boolean paramBoolean)
