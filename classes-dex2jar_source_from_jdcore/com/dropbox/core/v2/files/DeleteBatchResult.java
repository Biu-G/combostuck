  ...
  extends FileOpsResult
{
    ...
    extends StructSerializer<DeleteBatchResult>
  {
    ...
    public DeleteBatchResult a(JsonParser paramJsonParser, boolean paramBoolean)
      ...
      if (localObject1 == null)
      {
        ...
        while (paramJsonParser.getCurrentToken() == JsonToken.FIELD_NAME)
        {
          ...
          if ("entries".equals(localObject2)) {
            localObject1 = (List)StoneSerializers.list(DeleteBatchResultEntry.a.a).deserialize(paramJsonParser);
          } else {
        ...
        if (localObject1 != null)
        {
          localObject1 = new DeleteBatchResult((List)localObject1);
          if (!paramBoolean) {
    ...
    public void a(DeleteBatchResult paramDeleteBatchResult, JsonGenerator paramJsonGenerator, boolean paramBoolean)
      throws IOException, JsonGenerationException
    {
      ...
      StoneSerializers.list(DeleteBatchResultEntry.a.a).serialize(entries, paramJsonGenerator);
      if (!paramBoolean) {
