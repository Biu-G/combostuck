...
class b
{
  protected final List<DeleteArg> a;
  
  public b(List<DeleteArg> paramList)
  {
    if (paramList != null)
    {
    ...
    extends StructSerializer<b>
  {
      ...
      if (localObject1 == null)
      {
        ...
        while (paramJsonParser.getCurrentToken() == JsonToken.FIELD_NAME)
        {
          ...
          if ("entries".equals(localObject2)) {
            localObject1 = (List)StoneSerializers.list(DeleteArg.a.a).deserialize(paramJsonParser);
          } else {
      ...
      throws IOException, JsonGenerationException
    {
      ...
      StoneSerializers.list(DeleteArg.a.a).serialize(a, paramJsonGenerator);
      if (!paramBoolean) {
