...
public class ContentSyncSettingArg
{
  ...
  public ContentSyncSettingArg(String paramString, SyncSettingArg paramSyncSettingArg)
  {
    if (paramString != null)
    {
  ...
  public boolean equals(Object paramObject)
  {
    ...
    {
      paramObject = (ContentSyncSettingArg)paramObject;
    ...
    extends StructSerializer<ContentSyncSettingArg>
  {
    ...
    public ContentSyncSettingArg deserialize(JsonParser paramJsonParser, boolean paramBoolean)
      ...
      if (localObject1 == null)
      {
        ...
        while (paramJsonParser.getCurrentToken() == JsonToken.FIELD_NAME)
        {
          ...
          if ("id".equals(str)) {
            ...
            localObject1 = SyncSettingArg.Serializer.INSTANCE.deserialize(paramJsonParser);
          } else {
        ...
        if (localObject2 != null)
        {
          if (localObject1 != null)
          {
            localObject1 = new ContentSyncSettingArg((String)localObject2, (SyncSettingArg)localObject1);
            if (!paramBoolean) {
    ...
    public void serialize(ContentSyncSettingArg paramContentSyncSettingArg, JsonGenerator paramJsonGenerator, boolean paramBoolean)
      throws IOException, JsonGenerationException
    {
      ...
      SyncSettingArg.Serializer.INSTANCE.serialize(syncSetting, paramJsonGenerator);
      if (!paramBoolean) {
