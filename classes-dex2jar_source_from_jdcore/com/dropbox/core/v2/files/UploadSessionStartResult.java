...
public class UploadSessionStartResult
{
  ...
  public int hashCode()
  {
    return Arrays.hashCode(new Object[] { sessionId });
  }
    ...
    extends StructSerializer<UploadSessionStartResult>
  {
    ...
    public UploadSessionStartResult a(JsonParser paramJsonParser, boolean paramBoolean)
      throws IOException, JsonParseException
    {
      ...
      if (localObject1 == null)
      {
        ...
        while (paramJsonParser.getCurrentToken() == JsonToken.FIELD_NAME)
        {
          ...
          if ("session_id".equals(localObject2)) {
        ...
        if (localObject1 != null)
        {
          localObject1 = new UploadSessionStartResult((String)localObject1);
          if (!paramBoolean) {
    ...
    public void a(UploadSessionStartResult paramUploadSessionStartResult, JsonGenerator paramJsonGenerator, boolean paramBoolean)
