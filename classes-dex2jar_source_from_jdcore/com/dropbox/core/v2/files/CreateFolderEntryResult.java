...
public class CreateFolderEntryResult
{
  ...
  public CreateFolderEntryResult(FolderMetadata paramFolderMetadata)
  {
  ...
  public boolean equals(Object paramObject)
  {
    ...
    {
      paramObject = (CreateFolderEntryResult)paramObject;
  ...
  public int hashCode()
  {
    return Arrays.hashCode(new Object[] { metadata });
  }
  ...
  static class a
    extends StructSerializer<CreateFolderEntryResult>
  {
    public static final a a = new a();
    
    a() {}
    
    public CreateFolderEntryResult a(JsonParser paramJsonParser, boolean paramBoolean)
      throws IOException, JsonParseException
    {
      ...
      if (localObject1 == null)
      {
        ...
        if (localObject1 != null)
        {
          localObject1 = new CreateFolderEntryResult((FolderMetadata)localObject1);
          if (!paramBoolean) {
    ...
    public void a(CreateFolderEntryResult paramCreateFolderEntryResult, JsonGenerator paramJsonGenerator, boolean paramBoolean)
