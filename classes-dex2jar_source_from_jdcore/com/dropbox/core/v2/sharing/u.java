...
class u
{
  ...
  static class a
    extends StructSerializer<u>
  {
    public static final a a = new a();
    
    a() {}
    
    public u a(JsonParser paramJsonParser, boolean paramBoolean)
      throws IOException, JsonParseException
    {
      ...
      if (localObject1 == null)
      {
        ...
        while (paramJsonParser.getCurrentToken() == JsonToken.FIELD_NAME)
        {
          ...
          if ("shared_folder_id".equals(localObject2)) {
    ...
    public void a(u paramU, JsonGenerator paramJsonGenerator, boolean paramBoolean)
