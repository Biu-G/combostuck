...
public class ListSharedLinksResult
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if (paramObject.getClass().equals(getClass()))
    {
      ...
      if (((links == links) || (links.equals(links))) && (hasMore == hasMore))
      {
        if (cursor == cursor) {
          break label108;
        }
  ...
  public int hashCode()
  {
    return Arrays.hashCode(new Object[] { links, Boolean.valueOf(hasMore), cursor });
  }
    ...
    extends StructSerializer<ListSharedLinksResult>
  {
    ...
    public ListSharedLinksResult a(JsonParser paramJsonParser, boolean paramBoolean)
      throws IOException, JsonParseException
    {
      ...
      if (localObject1 == null)
      {
        ...
        while (paramJsonParser.getCurrentToken() == JsonToken.FIELD_NAME)
        {
          ...
          if ("links".equals(str)) {
            localList = (List)StoneSerializers.list(SharedLinkMetadata.a.a).deserialize(paramJsonParser);
        ...
        if (localList != null)
        {
          ...
          {
            localObject1 = new ListSharedLinksResult(localList, ((Boolean)localObject2).booleanValue(), (String)localObject1);
            if (!paramBoolean) {
    ...
    public void a(ListSharedLinksResult paramListSharedLinksResult, JsonGenerator paramJsonGenerator, boolean paramBoolean)
      throws IOException, JsonGenerationException
    {
      ...
      StoneSerializers.list(SharedLinkMetadata.a.a).serialize(links, paramJsonGenerator);
