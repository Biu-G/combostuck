...
public class ListFileMembersBatchResult
{
    ...
    if (paramString != null)
    {
      if (paramString.length() >= 1)
      {
        if (Pattern.matches("((/|id:).*|nspath:[0-9]+:.*)|ns:[0-9]+(/.*)?", paramString))
        {
          ...
          {
            result = paramListFileMembersIndividualResult;
            return;
          }
    ...
    extends StructSerializer<ListFileMembersBatchResult>
  {
    ...
    public ListFileMembersBatchResult a(JsonParser paramJsonParser, boolean paramBoolean)
      ...
      if (localObject1 == null)
      {
        ...
        while (paramJsonParser.getCurrentToken() == JsonToken.FIELD_NAME)
        {
          ...
          if ("file".equals(str)) {
            ...
            localObject1 = ListFileMembersIndividualResult.a.a.a(paramJsonParser);
          } else {
        ...
        if (localObject2 != null)
        {
          if (localObject1 != null)
          {
            localObject1 = new ListFileMembersBatchResult((String)localObject2, (ListFileMembersIndividualResult)localObject1);
            if (!paramBoolean) {
    ...
    public void a(ListFileMembersBatchResult paramListFileMembersBatchResult, JsonGenerator paramJsonGenerator, boolean paramBoolean)
      throws IOException, JsonGenerationException
    {
      ...
      ListFileMembersIndividualResult.a.a.a(result, paramJsonGenerator);
      if (!paramBoolean) {
