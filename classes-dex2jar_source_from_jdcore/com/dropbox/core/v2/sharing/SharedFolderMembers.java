...
public class SharedFolderMembers
{
    ...
    extends StructSerializer<SharedFolderMembers>
  {
    ...
    public SharedFolderMembers a(JsonParser paramJsonParser, boolean paramBoolean)
      throws IOException, JsonParseException
    {
      ...
      if (localObject1 == null)
      {
        ...
        while (paramJsonParser.getCurrentToken() == JsonToken.FIELD_NAME)
        {
          ...
          if ("users".equals(str)) {
            localList2 = (List)StoneSerializers.list(UserMembershipInfo.a.a).deserialize(paramJsonParser);
        ...
        if (localList2 != null)
        {
          if (localList1 != null)
          {
            if (localObject1 != null)
            {
              localObject1 = new SharedFolderMembers(localList2, localList1, (List)localObject1, (String)localObject2);
              if (!paramBoolean) {
    ...
    public void a(SharedFolderMembers paramSharedFolderMembers, JsonGenerator paramJsonGenerator, boolean paramBoolean)
      throws IOException, JsonGenerationException
    {
      ...
      StoneSerializers.list(UserMembershipInfo.a.a).serialize(users, paramJsonGenerator);
