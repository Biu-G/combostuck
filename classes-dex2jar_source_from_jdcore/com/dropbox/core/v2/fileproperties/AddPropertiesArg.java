...
public class AddPropertiesArg
{
  ...
  public AddPropertiesArg(String paramString, List<PropertyGroup> paramList)
  {
    if (paramString != null)
    {
  ...
  public boolean equals(Object paramObject)
  {
    ...
    {
      paramObject = (AddPropertiesArg)paramObject;
  ...
  public static class Serializer
    extends StructSerializer<AddPropertiesArg>
  {
    public static final Serializer INSTANCE = new Serializer();
    
    public Serializer() {}
    
    public AddPropertiesArg deserialize(JsonParser paramJsonParser, boolean paramBoolean)
      throws IOException, JsonParseException
    {
      ...
      if (localObject1 == null)
      {
        ...
        if (localObject2 != null)
        {
          if (localObject1 != null)
          {
            localObject1 = new AddPropertiesArg((String)localObject2, (List)localObject1);
            if (!paramBoolean) {
    ...
    public void serialize(AddPropertiesArg paramAddPropertiesArg, JsonGenerator paramJsonGenerator, boolean paramBoolean)
