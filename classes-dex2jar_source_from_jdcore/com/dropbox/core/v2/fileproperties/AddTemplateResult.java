...
public class AddTemplateResult
{
  ...
  public AddTemplateResult(String paramString)
  {
    if (paramString != null)
    {
  ...
  public boolean equals(Object paramObject)
  {
    ...
    {
      paramObject = (AddTemplateResult)paramObject;
  ...
  public static class Serializer
    extends StructSerializer<AddTemplateResult>
  {
    public static final Serializer INSTANCE = new Serializer();
    
    public Serializer() {}
    
    public AddTemplateResult deserialize(JsonParser paramJsonParser, boolean paramBoolean)
      throws IOException, JsonParseException
    {
      ...
      if (localObject1 == null)
      {
        ...
        if (localObject1 != null)
        {
          localObject1 = new AddTemplateResult((String)localObject1);
          if (!paramBoolean) {
    ...
    public void serialize(AddTemplateResult paramAddTemplateResult, JsonGenerator paramJsonGenerator, boolean paramBoolean)
