...
public class AddTemplateArg
  extends PropertyGroupTemplate
{
  public AddTemplateArg(String paramString1, String paramString2, List<PropertyFieldTemplate> paramList)
  {
  ...
  public boolean equals(Object paramObject)
  {
    ...
    {
      paramObject = (AddTemplateArg)paramObject;
  ...
  public static class Serializer
    extends StructSerializer<AddTemplateArg>
  {
    public static final Serializer INSTANCE = new Serializer();
    
    public Serializer() {}
    
    public AddTemplateArg deserialize(JsonParser paramJsonParser, boolean paramBoolean)
      ...
      if (localObject1 == null)
      {
        ...
        if (str1 != null)
        {
          if (localObject2 != null)
          {
            if (localObject1 != null)
            {
              localObject1 = new AddTemplateArg(str1, (String)localObject2, (List)localObject1);
              if (!paramBoolean) {
    ...
    public void serialize(AddTemplateArg paramAddTemplateArg, JsonGenerator paramJsonGenerator, boolean paramBoolean)
