...
public final class LookupError
{
    ...
    extends UnionSerializer<LookupError>
  {
    ...
    public LookupError a(JsonParser paramJsonParser)
      throws IOException, JsonParseException
    {
      ...
      if (localObject != null)
      {
        if ("malformed_path".equals(localObject))
        {
          ...
          localObject = LookupError.malformedPath((String)StoneSerializers.string().deserialize(paramJsonParser));
        }
    ...
    public void a(LookupError paramLookupError, JsonGenerator paramJsonGenerator)
      throws IOException, JsonGenerationException
    {
      ...
      StoneSerializers.string().serialize(LookupError.a(paramLookupError), paramJsonGenerator);
