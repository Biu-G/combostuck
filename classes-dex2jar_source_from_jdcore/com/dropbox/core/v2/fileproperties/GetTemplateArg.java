...
public class GetTemplateArg
{
  ...
  public GetTemplateArg(String paramString)
  {
    if (paramString != null)
    {
  ...
  public boolean equals(Object paramObject)
  {
    ...
    {
      paramObject = (GetTemplateArg)paramObject;
  ...
  public static class Serializer
    extends StructSerializer<GetTemplateArg>
  {
    public static final Serializer INSTANCE = new Serializer();
    
    public Serializer() {}
    
    public GetTemplateArg deserialize(JsonParser paramJsonParser, boolean paramBoolean)
      throws IOException, JsonParseException
    {
      ...
      if (localObject1 == null)
      {
        ...
        if (localObject1 != null)
        {
          localObject1 = new GetTemplateArg((String)localObject1);
          if (!paramBoolean) {
    ...
    public void serialize(GetTemplateArg paramGetTemplateArg, JsonGenerator paramJsonGenerator, boolean paramBoolean)
