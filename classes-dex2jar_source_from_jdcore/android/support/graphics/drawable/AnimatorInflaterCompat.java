...
public class AnimatorInflaterCompat
{
      ...
      if (m == 2)
      {
        ...
        for (;;)
        {
          ...
          else if (((String)localObject1).equals("set"))
          {
            ...
            localObject3 = TypedArrayUtils.obtainAttributes(paramResources, paramTheme, paramAttributeSet, a.h);
  ...
  private static void a(ValueAnimator paramValueAnimator, TypedArray paramTypedArray, int paramInt, float paramFloat, XmlPullParser paramXmlPullParser)
  {
    ...
    if (str1 != null)
    {
      ...
      a(PathParser.createPathFromPathData(str1), paramValueAnimator, paramFloat * 0.5F, str2, paramXmlPullParser);
      return;
    }
    ...
    throws Resources.NotFoundException
  {
    ...
    //   9: aload_1
    //   10: iload_3
    //   11: invokevirtual 475	android/content/res/Resources:getAnimation	(I)Landroid/content/res/XmlResourceParser;
    //   14: astore 6
    //   16: aload_0
    //   17: aload_1
    //   18: aload_2
    //   19: aload 6
    //   21: fload 4
    //   23: invokestatic 477	android/support/graphics/drawable/AnimatorInflaterCompat:a	(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;F)Landroid/animation/Animator;
    //   26: astore_0
    //   27: aload 6
    //   29: ifnull +10 -> 39
    //   32: aload 6
    //   34: invokeinterface 482 1 0
    //   39: aload_0
    //   40: areturn
    //   41: astore_0
    //   42: aload 6
    ...
    //   71: aload_0
    //   72: astore 5
    //   74: new 130	java/lang/StringBuilder
    //   77: dup
    //   78: invokespecial 131	java/lang/StringBuilder:<init>	()V
    //   81: astore_2
    //   82: aload_0
    //   83: astore 5
    //   85: aload_2
    ...
    //   96: aload_2
    //   97: iload_3
    //   98: invokestatic 487	java/lang/Integer:toHexString	(I)Ljava/lang/String;
    //   101: invokevirtual 137	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   104: pop
    //   105: aload_0
    //   106: astore 5
    //   108: new 227	android/content/res/Resources$NotFoundException
    //   111: dup
    //   112: aload_2
    //   113: invokevirtual 142	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   116: invokespecial 488	android/content/res/Resources$NotFoundException:<init>	(Ljava/lang/String;)V
    //   119: astore_2
    //   120: aload_0
    //   121: astore 5
    //   123: aload_2
    //   124: aload_1
    //   125: invokevirtual 492	android/content/res/Resources$NotFoundException:initCause	(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    //   128: pop
    //   129: aload_0
    //   130: astore 5
    //   132: aload_2
    ...
    //   159: aload_2
    //   160: iload_3
    //   161: invokestatic 487	java/lang/Integer:toHexString	(I)Ljava/lang/String;
    //   164: invokevirtual 137	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   167: pop
    //   168: aload_0
    //   169: astore 5
    //   171: new 227	android/content/res/Resources$NotFoundException
    //   174: dup
    //   175: aload_2
    //   176: invokevirtual 142	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   179: invokespecial 488	android/content/res/Resources$NotFoundException:<init>	(Ljava/lang/String;)V
    //   182: astore_2
    //   183: aload_0
    //   184: astore 5
    //   186: aload_2
    //   187: aload_1
    //   188: invokevirtual 492	android/content/res/Resources$NotFoundException:initCause	(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    //   191: pop
    //   192: aload_0
    //   193: astore 5
    //   195: aload_2
    ...
    implements TypeEvaluator<PathParser.PathDataNode[]>
  {
    ...
    public PathParser.PathDataNode[] a(float paramFloat, PathParser.PathDataNode[] paramArrayOfPathDataNode1, PathParser.PathDataNode[] paramArrayOfPathDataNode2)
    {
      ...
      {
        if ((a == null) || (!PathParser.canMorph(a, paramArrayOfPathDataNode1))) {
          a = PathParser.deepCopyNodes(paramArrayOfPathDataNode1);
        }
        int i = 0;
        while (i < paramArrayOfPathDataNode1.length)
        {
          a[i].interpolatePathDataNode(paramArrayOfPathDataNode1[i], paramArrayOfPathDataNode2[i], paramFloat);
          i += 1;
        }
        return a;
      }
