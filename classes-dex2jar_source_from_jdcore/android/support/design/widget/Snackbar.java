  ...
  extends BaseTransientBottomBar<Snackbar>
{
  ...
  private static final int[] e = { R.attr.snackbarButtonStyle };
  private final AccessibilityManager c;
  private boolean d;
  @Nullable
  private BaseTransientBottomBar.BaseCallback<Snackbar> f;
  ...
  private Snackbar(ViewGroup paramViewGroup, View paramView, ContentViewCallback paramContentViewCallback)
  {
    ...
    c = ((AccessibilityManager)paramViewGroup.getContext().getSystemService("accessibility"));
  }
  ...
  {
    if ((d) && (c.isTouchExplorationEnabled())) {
      return -2;
    }
