...
import android.support.v7.preference.R.style;
  ...
  implements DialogPreference.TargetFragment, PreferenceManager.OnDisplayPreferenceDialogListener, PreferenceManager.OnNavigateToScreenListener, PreferenceManager.OnPreferenceTreeClickListener
{
  ...
  private void a(final Preference paramPreference, final String paramString)
  {
    paramPreference = new Runnable()
    {
      public void run()
      {
        ...
        localAdapter.registerAdapterDataObserver(new PreferenceFragment.b(localAdapter, a, paramPreference, paramString));
      }
    };
    if (a == null)
    {
  ...
  {
    Object localObject = e.obtainStyledAttributes(null, R.styleable.PreferenceFragment, TypedArrayUtils.getAttr(e, R.attr.preferenceFragmentStyle, 16844038), 0);
    f = ((TypedArray)localObject).getResourceId(R.styleable.PreferenceFragment_android_layout, f);
    Drawable localDrawable = ((TypedArray)localObject).getDrawable(R.styleable.PreferenceFragment_android_divider);
    int k = ((TypedArray)localObject).getDimensionPixelSize(R.styleable.PreferenceFragment_android_dividerHeight, -1);
    ...
    extends RecyclerView.AdapterDataObserver
  {
    ...
    b(RecyclerView.Adapter paramAdapter, RecyclerView paramRecyclerView, Preference paramPreference, String paramString)
    {
      a = paramAdapter;
      b = paramRecyclerView;
      c = paramPreference;
