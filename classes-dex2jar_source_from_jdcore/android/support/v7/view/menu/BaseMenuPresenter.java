  ...
  implements MenuPresenter
{
  ...
  {
    return (MenuView.ItemView)mSystemInflater.inflate(c, paramViewGroup, false);
  }
  ...
  public MenuView getMenuView(ViewGroup paramViewGroup)
  {
    if (mMenuView == null)
    {
      mMenuView = ((MenuView)mSystemInflater.inflate(b, paramViewGroup, false));
  ...
  {
    if (a != null) {
      a.onCloseMenu(paramMenuBuilder, paramBoolean);
    }
  }
  ...
  {
    if (a != null) {
      return a.onOpenSubMenu(paramSubMenuBuilder);
    }
    return false;
  }
