...
{
  public abstract BackgroundCallback<T> a(BackgroundCallback<T> paramBackgroundCallback);
  
  public abstract MainThreadCallback<T> a(MainThreadCallback<T> paramMainThreadCallback);
