...
class FocusStrategy
{
  ...
  public static <L, T> T a(@NonNull L paramL, @NonNull CollectionAdapter<L, T> paramCollectionAdapter, @NonNull BoundsAdapter<T> paramBoundsAdapter, @Nullable T paramT, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    Collections.sort(localArrayList, new a(paramBoolean1, paramBoundsAdapter));
    switch (paramInt)
    {
    default: 
  ...
  private static boolean b(int paramInt, @NonNull Rect paramRect1, @NonNull Rect paramRect2)
  {
    boolean bool2 = false;
    boolean bool3 = false;
    boolean bool4 = false;
  ...
  private static boolean b(int paramInt, @NonNull Rect paramRect1, @NonNull Rect paramRect2, @NonNull Rect paramRect3)
  {
    ...
    if (!a(paramInt, paramRect1, paramRect3))
    {
      ...
      if (paramInt != 17)
      {
        ...
        return c(paramInt, paramRect1, paramRect2) < e(paramInt, paramRect1, paramRect3);
      }
      return true;
    }
    return false;
  ...
  private static int d(int paramInt, @NonNull Rect paramRect1, @NonNull Rect paramRect2)
  {
    if (paramInt != 17)
    {
      if (paramInt != 33)
  ...
  private static int e(int paramInt, @NonNull Rect paramRect1, @NonNull Rect paramRect2)
  {
    return Math.max(1, f(paramInt, paramRect1, paramRect2));
  }
  
  private static int f(int paramInt, @NonNull Rect paramRect1, @NonNull Rect paramRect2)
  {
    if (paramInt != 17)
    {
      if (paramInt != 33)
  ...
  private static int g(int paramInt, @NonNull Rect paramRect1, @NonNull Rect paramRect2)
  {
    if (paramInt != 17)
    {
      if (paramInt != 33)
    ...
    implements Comparator<T>
  {
    ...
    public int compare(T paramT1, T paramT2)
    {
      Rect localRect1 = a;
      Rect localRect2 = b;
      d.obtainBounds(paramT1, localRect1);
      d.obtainBounds(paramT2, localRect2);
      int j = top;
      int k = top;
      int i = -1;
      if (j < k) {
