...
public final class ResourcesCompat
{
  ...
  private static Typeface a(@NonNull Context paramContext, int paramInt1, TypedValue paramTypedValue, int paramInt2, @Nullable FontCallback paramFontCallback, @Nullable Handler paramHandler, boolean paramBoolean)
  {
    Resources localResources = paramContext.getResources();
    localResources.getValue(paramInt1, paramTypedValue, true);
    paramContext = a(paramContext, localResources, paramTypedValue, paramInt1, paramInt2, paramFontCallback, paramHandler, paramBoolean);
  ...
  private static Typeface a(@NonNull Context paramContext, Resources paramResources, TypedValue paramTypedValue, int paramInt1, int paramInt2, @Nullable FontCallback paramFontCallback, @Nullable Handler paramHandler, boolean paramBoolean)
  {
    if (string != null)
    {
    ...
    throws Resources.NotFoundException
  {
    ...
    return a(paramContext, paramInt1, paramTypedValue, paramInt2, paramFontCallback, null, true);
  }
  ...
  public static abstract class FontCallback
  {
    ...
    public final void callbackFailAsync(final int paramInt, @Nullable Handler paramHandler)
    {
      ...
      localHandler.post(new Runnable()
      {
        public void run()
        {
          onFontRetrievalFailed(paramInt);
        }
      });
    }
