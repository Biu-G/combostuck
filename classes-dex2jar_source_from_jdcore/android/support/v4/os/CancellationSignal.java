...
public final class CancellationSignal
{
  ...
  public void cancel()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 29	android/support/v4/os/CancellationSignal:a	Z
    //   6: ifeq +6 -> 12
    //   9: aload_0
    //   10: monitorexit
    //   11: return
    //   12: aload_0
    //   13: iconst_1
    //   14: putfield 29	android/support/v4/os/CancellationSignal:a	Z
    //   17: aload_0
    //   18: iconst_1
    //   19: putfield 23	android/support/v4/os/CancellationSignal:d	Z
    //   22: aload_0
    //   23: getfield 31	android/support/v4/os/CancellationSignal:b	Landroid/support/v4/os/CancellationSignal$OnCancelListener;
    //   26: astore_1
    //   27: aload_0
    //   28: getfield 33	android/support/v4/os/CancellationSignal:c	Ljava/lang/Object;
    //   31: astore_2
    //   32: aload_0
    //   33: monitorexit
    //   34: aload_1
    ...
    //   71: aload_0
    //   72: iconst_0
    //   73: putfield 23	android/support/v4/os/CancellationSignal:d	Z
    //   76: aload_0
    ...
    //   91: aload_0
    //   92: iconst_0
    //   93: putfield 23	android/support/v4/os/CancellationSignal:d	Z
    //   96: aload_0
  ...
  public Object getCancellationSignalObject()
  {
    ...
    try
    {
      if (c == null)
      {
        c = new android.os.CancellationSignal();
        if (a) {
          ((android.os.CancellationSignal)c).cancel();
        }
      }
  ...
  public void setOnCancelListener(OnCancelListener paramOnCancelListener)
  {
    ...
    {
      a();
      if (b == paramOnCancelListener) {
        return;
      }
      b = paramOnCancelListener;
      if ((a) && (paramOnCancelListener != null))
      {
