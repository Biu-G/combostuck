  ...
  extends android.app.AppComponentFactory
{
  ...
  {
    return (Activity)CoreComponentFactory.a(instantiateActivityCompat(paramClassLoader, paramString, paramIntent));
  }
  ...
  public final Application instantiateApplication(ClassLoader paramClassLoader, String paramString)
    throws InstantiationException, IllegalAccessException, ClassNotFoundException
  {
    return (Application)CoreComponentFactory.a(instantiateApplicationCompat(paramClassLoader, paramString));
  }
  ...
  public final ContentProvider instantiateProvider(ClassLoader paramClassLoader, String paramString)
    throws InstantiationException, IllegalAccessException, ClassNotFoundException
  {
    return (ContentProvider)CoreComponentFactory.a(instantiateProviderCompat(paramClassLoader, paramString));
  }
  ...
  public final BroadcastReceiver instantiateReceiver(ClassLoader paramClassLoader, String paramString, Intent paramIntent)
    throws InstantiationException, IllegalAccessException, ClassNotFoundException
  {
    return (BroadcastReceiver)CoreComponentFactory.a(instantiateReceiverCompat(paramClassLoader, paramString, paramIntent));
  }
  ...
  public final Service instantiateService(ClassLoader paramClassLoader, String paramString, Intent paramIntent)
    throws InstantiationException, IllegalAccessException, ClassNotFoundException
  {
    return (Service)CoreComponentFactory.a(instantiateServiceCompat(paramClassLoader, paramString, paramIntent));
  }
