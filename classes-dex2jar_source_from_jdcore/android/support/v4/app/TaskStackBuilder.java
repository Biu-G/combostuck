  ...
  implements Iterable<Intent>
{
  ...
  public TaskStackBuilder addNextIntentWithParentStack(@NonNull Intent paramIntent)
  {
    ...
    if (localComponentName2 == null) {
      localComponentName1 = paramIntent.resolveActivity(b.getPackageManager());
    }
  ...
  public TaskStackBuilder addParentStack(@NonNull Activity paramActivity)
  {
    ...
    if (localObject2 != null)
    {
      ...
      if (localObject1 == null) {
        paramActivity = ((Intent)localObject2).resolveActivity(b.getPackageManager());
      }
  ...
  public TaskStackBuilder addParentStack(ComponentName paramComponentName)
  {
    ...
    try
    {
      for (paramComponentName = NavUtils.getParentActivityIntent(b, paramComponentName); paramComponentName != null; paramComponentName = NavUtils.getParentActivityIntent(b, paramComponentName.getComponent())) {
  ...
  {
    return addParentStack(new ComponentName(b, paramClass));
  }
  
  @Nullable
  public Intent editIntentAt(int paramInt)
  {
    return (Intent)a.get(paramInt);
  }
  ...
  {
    Intent[] arrayOfIntent = new Intent[a.size()];
    if (arrayOfIntent.length == 0) {
      return arrayOfIntent;
    }
    arrayOfIntent[0] = new Intent((Intent)a.get(0)).addFlags(268484608);
    int i = 1;
    while (i < arrayOfIntent.length)
    {
      arrayOfIntent[i] = new Intent((Intent)a.get(i));
      i += 1;
    }
    return arrayOfIntent;
  }
  ...
  public PendingIntent getPendingIntent(int paramInt1, int paramInt2, @Nullable Bundle paramBundle)
  {
    if (!a.isEmpty())
    {
      ...
      if (Build.VERSION.SDK_INT >= 16) {
        return PendingIntent.getActivities(b, paramInt1, arrayOfIntent, paramInt2, paramBundle);
      }
      return PendingIntent.getActivities(b, paramInt1, arrayOfIntent, paramInt2);
    }
  ...
  public void startActivities(@Nullable Bundle paramBundle)
  {
    if (!a.isEmpty())
    {
      Intent[] arrayOfIntent = (Intent[])a.toArray(new Intent[a.size()]);
      arrayOfIntent[0] = new Intent(arrayOfIntent[0]).addFlags(268484608);
      if (!ContextCompat.startActivities(b, arrayOfIntent, paramBundle))
      {
        paramBundle = new Intent(arrayOfIntent[(arrayOfIntent.length - 1)]);
        paramBundle.addFlags(268435456);
        b.startActivity(paramBundle);
      }
      return;
    }
