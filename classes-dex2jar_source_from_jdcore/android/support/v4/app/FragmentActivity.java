  ...
  implements ViewModelStoreOwner, ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator
{
  ...
  boolean mCreated;
  final FragmentController mFragments = FragmentController.createController(new a());
  ...
  protected void onCreate(@Nullable Bundle paramBundle)
  {
    ...
    b localB = (b)getLastNonConfigurationInstance();
    if ((localB != null) && (b != null) && (mViewModelStore == null)) {
      mViewModelStore = b;
    }
    if (paramBundle != null)
    {
  ...
  public final Object onRetainNonConfigurationInstance()
  {
    ...
    a = localObject;
    b = mViewModelStore;
    c = localFragmentManagerNonConfig;
    return localB;
  }
