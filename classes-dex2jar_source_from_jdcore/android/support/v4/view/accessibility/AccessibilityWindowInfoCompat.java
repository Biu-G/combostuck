...
public class AccessibilityWindowInfoCompat
{
  ...
  public static AccessibilityWindowInfoCompat obtain(AccessibilityWindowInfoCompat paramAccessibilityWindowInfoCompat)
  {
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      return a(AccessibilityWindowInfo.obtain((AccessibilityWindowInfo)a));
    }
    return null;
  }
  ...
  public AccessibilityNodeInfoCompat getAnchor()
  {
    if (Build.VERSION.SDK_INT >= 24) {
      return AccessibilityNodeInfoCompat.a(((AccessibilityWindowInfo)a).getAnchor());
    }
    return null;
  }
  ...
  {
    if (Build.VERSION.SDK_INT >= 21) {
      ((AccessibilityWindowInfo)a).getBoundsInScreen(paramRect);
    }
  }
  ...
  {
    if (Build.VERSION.SDK_INT >= 21) {
      return a(((AccessibilityWindowInfo)a).getChild(paramInt));
    }
    return null;
  }
  ...
  {
    if (Build.VERSION.SDK_INT >= 21) {
      return ((AccessibilityWindowInfo)a).getChildCount();
    }
    return 0;
  }
  ...
  {
    if (Build.VERSION.SDK_INT >= 21) {
      return ((AccessibilityWindowInfo)a).getId();
    }
    return -1;
  }
  ...
  {
    if (Build.VERSION.SDK_INT >= 21) {
      return ((AccessibilityWindowInfo)a).getLayer();
    }
    return -1;
  }
  ...
  {
    if (Build.VERSION.SDK_INT >= 21) {
      return a(((AccessibilityWindowInfo)a).getParent());
    }
    return null;
  }
  ...
  {
    if (Build.VERSION.SDK_INT >= 21) {
      return AccessibilityNodeInfoCompat.a(((AccessibilityWindowInfo)a).getRoot());
    }
    return null;
  }
  ...
  {
    if (Build.VERSION.SDK_INT >= 24) {
      return ((AccessibilityWindowInfo)a).getTitle();
    }
    return null;
  }
  ...
  {
    if (Build.VERSION.SDK_INT >= 21) {
      return ((AccessibilityWindowInfo)a).getType();
    }
    return -1;
  }
  ...
  {
    if (Build.VERSION.SDK_INT >= 21) {
      return ((AccessibilityWindowInfo)a).isAccessibilityFocused();
    }
    return true;
  }
  ...
  {
    if (Build.VERSION.SDK_INT >= 21) {
      return ((AccessibilityWindowInfo)a).isActive();
    }
    return true;
  }
  ...
  {
    if (Build.VERSION.SDK_INT >= 21) {
      return ((AccessibilityWindowInfo)a).isFocused();
    }
    return true;
  }
  ...
  {
    if (Build.VERSION.SDK_INT >= 21) {
      ((AccessibilityWindowInfo)a).recycle();
    }
  }
  ...
  public String toString()
  {
    ...
    localStringBuilder.append(a(getType()));
