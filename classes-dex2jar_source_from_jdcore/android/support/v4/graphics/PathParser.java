...
public class PathParser
{
  ...
  private static void a(ArrayList<PathDataNode> paramArrayList, char paramChar, float[] paramArrayOfFloat)
  {
  ...
  public static class PathDataNode
  {
    ...
    {
      mType = mType;
      mParams = PathParser.a(mParams, 0, mParams.length);
    }
    ...
    public static void nodesToPath(PathDataNode[] paramArrayOfPathDataNode, Path paramPath)
    {
      ...
      while (i < paramArrayOfPathDataNode.length)
      {
        a(paramPath, arrayOfFloat, c, mType, mParams);
        c = mType;
        i += 1;
      }
    }
