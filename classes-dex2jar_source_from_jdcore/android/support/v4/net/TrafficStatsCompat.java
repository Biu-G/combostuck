...
public final class TrafficStatsCompat
{
    ...
    throws SocketException
  {
    ...
    TrafficStats.tagSocket(new a(paramDatagramSocket, localParcelFileDescriptor.getFileDescriptor()));
    ...
    throws SocketException
  {
    ...
    ParcelFileDescriptor localParcelFileDescriptor = ParcelFileDescriptor.fromDatagramSocket(paramDatagramSocket);
    TrafficStats.untagSocket(new a(paramDatagramSocket, localParcelFileDescriptor.getFileDescriptor()));
    localParcelFileDescriptor.detachFd();
  }
