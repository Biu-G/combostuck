...
public final class InputConnectionCompat
{
  ...
  static boolean a(@Nullable String paramString, @NonNull Bundle paramBundle, @NonNull OnCommitContentListener paramOnCommitContentListener)
  {
      ...
      if (paramEditorInfo != null)
      {
        if (paramOnCommitContentListener != null)
        {
          ...
          new InputConnectionWrapper(paramInputConnection, false)
          {
            ...
            {
              if (InputConnectionCompat.a(paramAnonymousString, paramAnonymousBundle, paramOnCommitContentListener)) {
                return true;
              }
