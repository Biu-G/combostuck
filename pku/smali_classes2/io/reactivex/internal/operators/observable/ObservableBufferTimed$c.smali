...
.method constructor <init>(Lio/reactivex/Observer;Ljava/util/concurrent/Callable;JJLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler$Worker;)V
    ...
    .line 233
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->b:Ljava/util/concurrent/Callable;

    .line 234
    iput-wide p3, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->c:J

    .line 235
    iput-wide p5, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->d:J

    .line 236
    iput-object p7, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->e:Ljava/util/concurrent/TimeUnit;
...
.method static synthetic a(Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;Ljava/lang/Object;ZLio/reactivex/disposables/Disposable;)V
    ...
    .line 217
    invoke-virtual {p0, p1, p2, p3}, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->fastPathOrderedEmit(Ljava/lang/Object;ZLio/reactivex/disposables/Disposable;)V
...
.method public dispose()V
    ...
    .line 304
    iget-boolean v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->cancelled:Z
    ...
    .line 305
    iput-boolean v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->cancelled:Z

    .line 306
    invoke-virtual {p0}, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->a()V
...
.method public onComplete()V
    ...
    .line 294
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->queue:Lio/reactivex/internal/fuseable/SimplePlainQueue;
    ...
    .line 296
    iput-boolean v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->done:Z

    .line 297
    invoke-virtual {p0}, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->enter()Z
    ...
    .line 298
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->queue:Lio/reactivex/internal/fuseable/SimplePlainQueue;

    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->actual:Lio/reactivex/Observer;
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    .line 281
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->actual:Lio/reactivex/Observer;
...
.method public onSubscribe(Lio/reactivex/disposables/Disposable;)V
    ...
    .line 249
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->b:Ljava/util/concurrent/Callable;
    ...
    .line 260
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->actual:Lio/reactivex/Observer;
    ...
    iget-wide v3, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->d:J

    iget-wide v5, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->d:J

    iget-object v7, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->e:Ljava/util/concurrent/TimeUnit;
    ...
    iget-wide v2, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->c:J

    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->e:Ljava/util/concurrent/TimeUnit;
...
.method public run()V
    ...
    .line 340
    :try_start_1
    iget-boolean v1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->cancelled:Z
    ...
    iget-wide v3, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$c;->c:J
