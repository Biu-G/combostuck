...
.field i:Lorg/reactivestreams/Publisher;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method constructor <init>(Lorg/reactivestreams/Subscriber;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler$Worker;Lorg/reactivestreams/Publisher;)V
    ...
    .line 202
    iput-object p6, p0, Lio/reactivex/internal/operators/flowable/FlowableTimeoutTimed$b;->i:Lorg/reactivestreams/Publisher;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableTimeoutTimed$b;->e:Lio/reactivex/internal/disposables/SequentialDisposable;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableTimeoutTimed$b;->f:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableTimeoutTimed$b;->g:Ljava/util/concurrent/atomic/AtomicLong;
...
.method public a(J)V
    ...
    .line 261
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableTimeoutTimed$b;->g:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 262
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableTimeoutTimed$b;->f:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-static {p1}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->cancel(Ljava/util/concurrent/atomic/AtomicReference;)Z

    .line 264
    iget-wide p1, p0, Lio/reactivex/internal/operators/flowable/FlowableTimeoutTimed$b;->h:J
    ...
    .line 266
    invoke-virtual {p0, p1, p2}, Lio/reactivex/internal/operators/flowable/FlowableTimeoutTimed$b;->produced(J)V

    .line 269
    :cond_0
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableTimeoutTimed$b;->i:Lorg/reactivestreams/Publisher;

    const/4 p2, 0x0

    .line 270
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableTimeoutTimed$b;->i:Lorg/reactivestreams/Publisher;
...
.method b(J)V
    ...
    .line 232
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableTimeoutTimed$b;->e:Lio/reactivex/internal/disposables/SequentialDisposable;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 218
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableTimeoutTimed$b;->g:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 224
    iget-wide v0, p0, Lio/reactivex/internal/operators/flowable/FlowableTimeoutTimed$b;->h:J

    add-long/2addr v0, v3

    iput-wide v0, p0, Lio/reactivex/internal/operators/flowable/FlowableTimeoutTimed$b;->h:J
    ...
    .line 228
    invoke-virtual {p0, v5, v6}, Lio/reactivex/internal/operators/flowable/FlowableTimeoutTimed$b;->b(J)V
...
.method public onSubscribe(Lorg/reactivestreams/Subscription;)V
    ...
    .line 210
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableTimeoutTimed$b;->f:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 211
    invoke-virtual {p0, p1}, Lio/reactivex/internal/operators/flowable/FlowableTimeoutTimed$b;->setSubscription(Lorg/reactivestreams/Subscription;)V
