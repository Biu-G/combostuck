...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 20
    iput v0, p0, Lid/zelory/compressor/Compressor;->a:I

    const/16 v0, 0x330

    .line 21
    iput v0, p0, Lid/zelory/compressor/Compressor;->b:I

    .line 22
    sget-object v0, Landroid/graphics/Bitmap$CompressFormat;->JPEG:Landroid/graphics/Bitmap$CompressFormat;

    iput-object v0, p0, Lid/zelory/compressor/Compressor;->c:Landroid/graphics/Bitmap$CompressFormat;

    const/16 v0, 0x50

    .line 23
    iput v0, p0, Lid/zelory/compressor/Compressor;->d:I
    ...
    iput-object p1, p0, Lid/zelory/compressor/Compressor;->e:Ljava/lang/String;
...
.method public compressToBitmap(Ljava/io/File;)Landroid/graphics/Bitmap;
    ...
    .line 65
    iget v0, p0, Lid/zelory/compressor/Compressor;->a:I

    iget v1, p0, Lid/zelory/compressor/Compressor;->b:I

    invoke-static {p1, v0, v1}, Lid/zelory/compressor/a;->a(Ljava/io/File;II)Landroid/graphics/Bitmap;
...
.method public compressToFile(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    .line 60
    iget v1, p0, Lid/zelory/compressor/Compressor;->a:I

    iget v2, p0, Lid/zelory/compressor/Compressor;->b:I

    iget-object v3, p0, Lid/zelory/compressor/Compressor;->c:Landroid/graphics/Bitmap$CompressFormat;

    iget v4, p0, Lid/zelory/compressor/Compressor;->d:I

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v5, p0, Lid/zelory/compressor/Compressor;->e:Ljava/lang/String;
    ...
    invoke-static/range {v0 .. v5}, Lid/zelory/compressor/a;->a(Ljava/io/File;IILandroid/graphics/Bitmap$CompressFormat;ILjava/lang/String;)Ljava/io/File;
...
.method public setCompressFormat(Landroid/graphics/Bitmap$CompressFormat;)Lid/zelory/compressor/Compressor;
    ...
    .line 41
    iput-object p1, p0, Lid/zelory/compressor/Compressor;->c:Landroid/graphics/Bitmap$CompressFormat;
...
.method public setMaxHeight(I)Lid/zelory/compressor/Compressor;
    ...
    .line 36
    iput p1, p0, Lid/zelory/compressor/Compressor;->b:I
...
.method public setMaxWidth(I)Lid/zelory/compressor/Compressor;
    ...
    .line 31
    iput p1, p0, Lid/zelory/compressor/Compressor;->a:I
...
.method public setQuality(I)Lid/zelory/compressor/Compressor;
    ...
    .line 46
    iput p1, p0, Lid/zelory/compressor/Compressor;->d:I
