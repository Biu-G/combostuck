...
.method public constructor <init>(Landroid/support/design/widget/TabLayout;Landroid/content/Context;)V
    ...
    .line 1967
    invoke-virtual {p0, p2}, Landroid/support/design/widget/TabLayout$d;->setGravity(I)V

    .line 1968
    iget-boolean p1, p1, Landroid/support/design/widget/TabLayout;->s:Z

    const/4 p2, 0x1

    xor-int/2addr p1, p2

    invoke-virtual {p0, p1}, Landroid/support/design/widget/TabLayout$d;->setOrientation(I)V

    .line 1969
    invoke-virtual {p0, p2}, Landroid/support/design/widget/TabLayout$d;->setClickable(Z)V
...
.method private a(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Landroid/support/design/widget/TabLayout$d;->h:Landroid/graphics/drawable/Drawable;

    .line 1977
    iget-object p1, p0, Landroid/support/design/widget/TabLayout$d;->h:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0}, Landroid/support/design/widget/TabLayout$d;->getDrawableState()[I
    ...
    .line 1981
    :cond_0
    iput-object v1, p0, Landroid/support/design/widget/TabLayout$d;->h:Landroid/graphics/drawable/Drawable;
    ...
    .line 1996
    iget-object v3, p0, Landroid/support/design/widget/TabLayout$d;->a:Landroid/support/design/widget/TabLayout;
    ...
    iget-boolean v4, v4, Landroid/support/design/widget/TabLayout;->u:Z
    ...
    .line 2016
    iget-object p1, p0, Landroid/support/design/widget/TabLayout$d;->a:Landroid/support/design/widget/TabLayout;
...
.method private a(Landroid/graphics/Canvas;)V
    ...
    .line 2030
    iget-object v0, p0, Landroid/support/design/widget/TabLayout$d;->h:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0}, Landroid/support/design/widget/TabLayout$d;->getLeft()I

    move-result v1

    invoke-virtual {p0}, Landroid/support/design/widget/TabLayout$d;->getTop()I

    move-result v2

    invoke-virtual {p0}, Landroid/support/design/widget/TabLayout$d;->getRight()I

    move-result v3

    invoke-virtual {p0}, Landroid/support/design/widget/TabLayout$d;->getBottom()I
...
.method private a(Landroid/widget/TextView;Landroid/widget/ImageView;)V
    ...
    .line 2289
    invoke-virtual {p0, v4}, Landroid/support/design/widget/TabLayout$d;->setVisibility(I)V
    ...
    :cond_8
    :goto_5
    iget-object p1, p0, Landroid/support/design/widget/TabLayout$d;->b:Landroid/support/design/widget/TabLayout$Tab;
...
.method private d()I
    ...
    iget-object v1, p0, Landroid/support/design/widget/TabLayout$d;->d:Landroid/widget/ImageView;

    const/4 v3, 0x1

    aput-object v1, v0, v3

    iget-object v1, p0, Landroid/support/design/widget/TabLayout$d;->e:Landroid/view/View;
...
.method final b()V
    ...
    .line 2194
    iget-object v3, p0, Landroid/support/design/widget/TabLayout$d;->c:Landroid/widget/TextView;
    ...
    .line 2197
    :cond_3
    iget-object v3, p0, Landroid/support/design/widget/TabLayout$d;->d:Landroid/widget/ImageView;
    ...
    .line 2203
    iget-object v3, p0, Landroid/support/design/widget/TabLayout$d;->f:Landroid/widget/TextView;
    ...
    iput v3, p0, Landroid/support/design/widget/TabLayout$d;->i:I
    ...
    iput-object v2, p0, Landroid/support/design/widget/TabLayout$d;->g:Landroid/widget/ImageView;

    goto :goto_1

    .line 2209
    :cond_6
    iget-object v2, p0, Landroid/support/design/widget/TabLayout$d;->e:Landroid/view/View;
    ...
    invoke-virtual {p0, v2}, Landroid/support/design/widget/TabLayout$d;->removeView(Landroid/view/View;)V

    .line 2211
    iput-object v1, p0, Landroid/support/design/widget/TabLayout$d;->e:Landroid/view/View;

    .line 2213
    :cond_7
    iput-object v1, p0, Landroid/support/design/widget/TabLayout$d;->f:Landroid/widget/TextView;

    .line 2214
    iput-object v1, p0, Landroid/support/design/widget/TabLayout$d;->g:Landroid/widget/ImageView;
    ...
    .line 2224
    invoke-virtual {p0, v2, v3}, Landroid/support/design/widget/TabLayout$d;->addView(Landroid/view/View;I)V

    .line 2225
    iput-object v2, p0, Landroid/support/design/widget/TabLayout$d;->d:Landroid/widget/ImageView;
    ...
    .line 2243
    invoke-virtual {p0, v1}, Landroid/support/design/widget/TabLayout$d;->addView(Landroid/view/View;)V

    .line 2244
    iput-object v1, p0, Landroid/support/design/widget/TabLayout$d;->c:Landroid/widget/TextView;
    ...
    iput v1, p0, Landroid/support/design/widget/TabLayout$d;->i:I
    ...
    .line 2254
    :cond_d
    iget-object v1, p0, Landroid/support/design/widget/TabLayout$d;->f:Landroid/widget/TextView;

    if-nez v1, :cond_e

    iget-object v1, p0, Landroid/support/design/widget/TabLayout$d;->g:Landroid/widget/ImageView;
    ...
    invoke-virtual {p0, v1}, Landroid/support/design/widget/TabLayout$d;->setContentDescription(Ljava/lang/CharSequence;)V
...
.method final c()V
    ...
    invoke-virtual {p0, v0}, Landroid/support/design/widget/TabLayout$d;->setOrientation(I)V
...
.method protected drawableStateChanged()V
    ...
    .line 2041
    iget-object v1, p0, Landroid/support/design/widget/TabLayout$d;->h:Landroid/graphics/drawable/Drawable;
    ...
    .line 2046
    invoke-virtual {p0}, Landroid/support/design/widget/TabLayout$d;->invalidate()V
...
.method public onMeasure(II)V
    ...
    iget p1, p1, Landroid/support/design/widget/TabLayout;->n:I
    ...
    iget v0, v0, Landroid/support/design/widget/TabLayout;->k:F

    .line 2129
    iget v1, p0, Landroid/support/design/widget/TabLayout$d;->i:I
    ...
    .line 2134
    :cond_2
    iget-object v2, p0, Landroid/support/design/widget/TabLayout$d;->c:Landroid/widget/TextView;
    ...
    iget v0, v0, Landroid/support/design/widget/TabLayout;->l:F
    ...
    .line 2147
    :cond_4
    iget-object v5, p0, Landroid/support/design/widget/TabLayout$d;->a:Landroid/support/design/widget/TabLayout;

    iget v5, v5, Landroid/support/design/widget/TabLayout;->r:I
