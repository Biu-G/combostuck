...
.method static constructor <clinit>()V
    ...
    :goto_1
    sput-boolean v0, Landroid/support/transition/n;->b:Z
    ...
    :cond_2
    sput-boolean v1, Landroid/support/transition/n;->c:Z
...
.method private static a(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;Landroid/view/ViewGroup;)Landroid/graphics/Bitmap;
    ...
    .line 102
    :goto_1
    sget-boolean v3, Landroid/support/transition/n;->b:Z
    ...
    .line 120
    sget-boolean p2, Landroid/support/transition/n;->c:Z
    ...
    :cond_5
    :goto_3
    sget-boolean p1, Landroid/support/transition/n;->b:Z
...
.method static a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/View;)Landroid/view/View;
    ...
    .line 53
    invoke-static {p1, v0}, Landroid/support/transition/aa;->a(Landroid/view/View;Landroid/graphics/Matrix;)V

    .line 54
    invoke-static {p0, v0}, Landroid/support/transition/aa;->b(Landroid/view/View;Landroid/graphics/Matrix;)V
    ...
    .line 64
    invoke-static {p1, v0, p2, p0}, Landroid/support/transition/n;->a(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;Landroid/view/ViewGroup;)Landroid/graphics/Bitmap;
