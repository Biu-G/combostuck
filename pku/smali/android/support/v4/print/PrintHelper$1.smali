...
.method constructor <init>(Landroid/support/v4/print/PrintHelper;Landroid/os/CancellationSignal;Landroid/print/PrintAttributes;Landroid/graphics/Bitmap;Landroid/print/PrintAttributes;ILandroid/os/ParcelFileDescriptor;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
    ...
    .line 635
    iput-object p1, p0, Landroid/support/v4/print/PrintHelper$1;->h:Landroid/support/v4/print/PrintHelper;

    iput-object p2, p0, Landroid/support/v4/print/PrintHelper$1;->a:Landroid/os/CancellationSignal;

    iput-object p3, p0, Landroid/support/v4/print/PrintHelper$1;->b:Landroid/print/PrintAttributes;

    iput-object p4, p0, Landroid/support/v4/print/PrintHelper$1;->c:Landroid/graphics/Bitmap;

    iput-object p5, p0, Landroid/support/v4/print/PrintHelper$1;->d:Landroid/print/PrintAttributes;

    iput p6, p0, Landroid/support/v4/print/PrintHelper$1;->e:I

    iput-object p7, p0, Landroid/support/v4/print/PrintHelper$1;->f:Landroid/os/ParcelFileDescriptor;

    iput-object p8, p0, Landroid/support/v4/print/PrintHelper$1;->g:Landroid/print/PrintDocumentAdapter$WriteResultCallback;
...
.method protected varargs a([Ljava/lang/Void;)Ljava/lang/Throwable;
    ...
    .line 639
    :try_start_0
    iget-object p1, p0, Landroid/support/v4/print/PrintHelper$1;->a:Landroid/os/CancellationSignal;
    ...
    iget-object v1, p0, Landroid/support/v4/print/PrintHelper$1;->h:Landroid/support/v4/print/PrintHelper;

    iget-object v1, v1, Landroid/support/v4/print/PrintHelper;->c:Landroid/content/Context;

    iget-object v2, p0, Landroid/support/v4/print/PrintHelper$1;->b:Landroid/print/PrintAttributes;
    ...
    .line 646
    iget-object v1, p0, Landroid/support/v4/print/PrintHelper$1;->c:Landroid/graphics/Bitmap;
    ...
    .line 649
    iget-object v2, p0, Landroid/support/v4/print/PrintHelper$1;->a:Landroid/os/CancellationSignal;
    ...
    iget-object v5, p0, Landroid/support/v4/print/PrintHelper$1;->h:Landroid/support/v4/print/PrintHelper;

    iget-object v5, v5, Landroid/support/v4/print/PrintHelper;->c:Landroid/content/Context;

    iget-object v6, p0, Landroid/support/v4/print/PrintHelper$1;->d:Landroid/print/PrintAttributes;
    ...
    iget v6, p0, Landroid/support/v4/print/PrintHelper$1;->e:I
    ...
    .line 702
    iget-object p1, p0, Landroid/support/v4/print/PrintHelper$1;->f:Landroid/os/ParcelFileDescriptor;
    :try_end_2
    ...
    :cond_4
    :try_start_4
    iget-object p1, p0, Landroid/support/v4/print/PrintHelper$1;->c:Landroid/graphics/Bitmap;
    ...
    iget-object v3, p0, Landroid/support/v4/print/PrintHelper$1;->f:Landroid/os/ParcelFileDescriptor;
...
.method protected a(Ljava/lang/Throwable;)V
    ...
    .line 721
    iget-object v0, p0, Landroid/support/v4/print/PrintHelper$1;->a:Landroid/os/CancellationSignal;
    ...
    .line 723
    iget-object p1, p0, Landroid/support/v4/print/PrintHelper$1;->g:Landroid/print/PrintDocumentAdapter$WriteResultCallback;
...
.method protected synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/print/PrintHelper$1;->a([Ljava/lang/Void;)Ljava/lang/Throwable;
...
.method protected synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/print/PrintHelper$1;->a(Ljava/lang/Throwable;)V
