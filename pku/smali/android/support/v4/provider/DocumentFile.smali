...
.method public static fromFile(Ljava/io/File;)Landroid/support/v4/provider/DocumentFile;
    ...
    .line 102
    new-instance v0, Landroid/support/v4/provider/b;

    const/4 v1, 0x0

    invoke-direct {v0, v1, p0}, Landroid/support/v4/provider/b;-><init>(Landroid/support/v4/provider/DocumentFile;Ljava/io/File;)V
...
.method public static fromSingleUri(Landroid/content/Context;Landroid/net/Uri;)Landroid/support/v4/provider/DocumentFile;
    ...
    .line 118
    new-instance v0, Landroid/support/v4/provider/c;

    invoke-direct {v0, v1, p0, p1}, Landroid/support/v4/provider/c;-><init>(Landroid/support/v4/provider/DocumentFile;Landroid/content/Context;Landroid/net/Uri;)V
...
.method public static fromTreeUri(Landroid/content/Context;Landroid/net/Uri;)Landroid/support/v4/provider/DocumentFile;
    ...
    invoke-direct {v0, v1, p0, p1}, Landroid/support/v4/provider/d;-><init>(Landroid/support/v4/provider/DocumentFile;Landroid/content/Context;Landroid/net/Uri;)V
