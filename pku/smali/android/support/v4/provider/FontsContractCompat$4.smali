...
.method constructor <init>(Landroid/content/Context;Landroid/support/v4/provider/FontRequest;Landroid/os/Handler;Landroid/support/v4/provider/FontsContractCompat$FontRequestCallback;)V
    ...
    .line 533
    iput-object p1, p0, Landroid/support/v4/provider/FontsContractCompat$4;->a:Landroid/content/Context;

    iput-object p2, p0, Landroid/support/v4/provider/FontsContractCompat$4;->b:Landroid/support/v4/provider/FontRequest;

    iput-object p3, p0, Landroid/support/v4/provider/FontsContractCompat$4;->c:Landroid/os/Handler;

    iput-object p4, p0, Landroid/support/v4/provider/FontsContractCompat$4;->d:Landroid/support/v4/provider/FontsContractCompat$FontRequestCallback;
...
.method public run()V
    ...
    .line 539
    :try_start_0
    iget-object v0, p0, Landroid/support/v4/provider/FontsContractCompat$4;->a:Landroid/content/Context;

    iget-object v1, p0, Landroid/support/v4/provider/FontsContractCompat$4;->b:Landroid/support/v4/provider/FontRequest;
    ...
    .line 573
    iget-object v0, p0, Landroid/support/v4/provider/FontsContractCompat$4;->c:Landroid/os/Handler;
    ...
    .line 611
    :cond_2
    iget-object v1, p0, Landroid/support/v4/provider/FontsContractCompat$4;->c:Landroid/os/Handler;
    ...
    .line 622
    :cond_4
    iget-object v1, p0, Landroid/support/v4/provider/FontsContractCompat$4;->a:Landroid/content/Context;
