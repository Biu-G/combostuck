...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {v1, p1, p2, p3, p4}, Landroid/support/v7/widget/g;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method private b()I
    ...
    .line 1138
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/r;
    ...
    invoke-virtual {p0, v0, v5}, Landroid/support/v7/widget/ListPopupWindow;->a(Landroid/content/Context;Z)Landroid/support/v7/widget/r;

    move-result-object v5

    iput-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/r;
    ...
    .line 1160
    iget-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/r;

    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->A:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v5, v6}, Landroid/support/v7/widget/r;->setSelector(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v5, v6}, Landroid/support/v7/widget/r;->setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {v5, v6}, Landroid/support/v7/widget/r;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V

    .line 1164
    iget-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/r;

    invoke-virtual {v5, v3}, Landroid/support/v7/widget/r;->setFocusable(Z)V

    .line 1165
    iget-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/r;

    invoke-virtual {v5, v3}, Landroid/support/v7/widget/r;->setFocusableInTouchMode(Z)V
    ...
    invoke-virtual {v5, v6}, Landroid/support/v7/widget/r;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V
    ...
    invoke-virtual {v5, v6}, Landroid/support/v7/widget/r;->setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V
    ...
    .line 1301
    :goto_7
    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/r;
    ...
    invoke-virtual/range {v6 .. v11}, Landroid/support/v7/widget/r;->measureHeightOfChildrenCompat(IIIII)I
    ...
    .line 1304
    iget-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/r;

    invoke-virtual {v2}, Landroid/support/v7/widget/r;->getPaddingTop()I

    move-result v2

    iget-object v3, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/r;

    .line 1305
    invoke-virtual {v3}, Landroid/support/v7/widget/r;->getPaddingBottom()I
...
# virtual methods
.method a(Landroid/content/Context;Z)Landroid/support/v7/widget/r;
    .locals 1
    .annotation build Landroid/support/annotation/NonNull;
    .end annotation
    ...
    invoke-direct {v0, p1, p2}, Landroid/support/v7/widget/r;-><init>(Landroid/content/Context;Z)V
...
.method public clearListSelection()V
    ...
    .line 829
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/r;->setListSelectionHidden(Z)V
...
.method public dismiss()V
    ...
    .line 755
    iput-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/r;
...
.method public getSelectedItem()Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/r;->getSelectedItem()Ljava/lang/Object;
...
.method public getSelectedItemId()J
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/r;->getSelectedItemId()J
...
.method public getSelectedItemPosition()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/r;->getSelectedItemPosition()I
...
.method public getSelectedView()Landroid/view/View;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/r;->getSelectedView()Landroid/view/View;
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 970
    iget-object v4, p0, Landroid/support/v7/widget/ListPopupWindow;->j:Landroid/widget/ListAdapter;
    ...
    .line 979
    invoke-virtual {v6, v1, v3}, Landroid/support/v7/widget/r;->lookForSelectablePosition(IZ)I
    ...
    invoke-virtual {v5, v4, v1}, Landroid/support/v7/widget/r;->lookForSelectablePosition(IZ)I
    ...
    .line 995
    :cond_6
    iget-object v8, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/r;

    invoke-virtual {v8, v1}, Landroid/support/v7/widget/r;->setListSelectionHidden(Z)V

    .line 998
    iget-object v8, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/r;

    invoke-virtual {v8, p1, p2}, Landroid/support/v7/widget/r;->onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 1004
    iget-object p2, p0, Landroid/support/v7/widget/ListPopupWindow;->g:Landroid/widget/PopupWindow;
    ...
    .line 1009
    iget-object p2, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/r;

    invoke-virtual {p2}, Landroid/support/v7/widget/r;->requestFocusFromTouch()Z
...
.method public onKeyPreIme(ILandroid/view/KeyEvent;)Z
    ...
    .line 1078
    iget-object p1, p0, Landroid/support/v7/widget/ListPopupWindow;->z:Landroid/view/View;
...
.method public onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/r;->onKeyUp(ILandroid/view/KeyEvent;)Z
...
.method public performItemClick(I)Z
    ...
    .line 860
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->B:Landroid/widget/AdapterView$OnItemClickListener;
    ...
    .line 862
    invoke-virtual {v2}, Landroid/support/v7/widget/r;->getFirstVisiblePosition()I

    move-result v0

    sub-int v0, p1, v0

    invoke-virtual {v2, v0}, Landroid/support/v7/widget/r;->getChildAt(I)Landroid/view/View;

    move-result-object v3

    .line 863
    invoke-virtual {v2}, Landroid/support/v7/widget/r;->getAdapter()Landroid/widget/ListAdapter;

    move-result-object v0

    .line 864
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->B:Landroid/widget/AdapterView$OnItemClickListener;
...
.method public postShow()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->G:Ljava/lang/Runnable;
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    .line 291
    :cond_2
    iget-object p1, p0, Landroid/support/v7/widget/ListPopupWindow;->c:Landroid/support/v7/widget/r;
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/r;->setAdapter(Landroid/widget/ListAdapter;)V
...
.method public setDropDownAlwaysVisible(Z)V
    ...
    .line 367
    iput-boolean p1, p0, Landroid/support/v7/widget/ListPopupWindow;->u:Z
...
.method public setForceIgnoreOutsideTouch(Z)V
    ...
    .line 351
    iput-boolean p1, p0, Landroid/support/v7/widget/ListPopupWindow;->v:Z
...
.method public setListSelector(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 410
    iput-object p1, p0, Landroid/support/v7/widget/ListPopupWindow;->A:Landroid/graphics/drawable/Drawable;
...
.method public setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V
    ...
    .line 614
    iput-object p1, p0, Landroid/support/v7/widget/ListPopupWindow;->C:Landroid/widget/AdapterView$OnItemSelectedListener;
...
.method public setSelection(I)V
    ...
    .line 813
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/r;->setSelection(I)V

    .line 815
    invoke-virtual {v0}, Landroid/support/v7/widget/r;->getChoiceMode()I
    ...
    .line 816
    invoke-virtual {v0, p1, v1}, Landroid/support/v7/widget/r;->setItemChecked(IZ)V
...
.method public show()V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/r;->setSelection(I)V
