...
.field private g:Landroid/support/v7/widget/ad;

.field private final h:Landroid/support/v7/widget/k;
...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    .line 60
    iput v0, p0, Landroid/support/v7/widget/j;->i:I

    .line 65
    iput-object p1, p0, Landroid/support/v7/widget/j;->a:Landroid/widget/TextView;

    .line 66
    new-instance p1, Landroid/support/v7/widget/k;

    iget-object v0, p0, Landroid/support/v7/widget/j;->a:Landroid/widget/TextView;

    invoke-direct {p1, v0}, Landroid/support/v7/widget/k;-><init>(Landroid/widget/TextView;)V

    iput-object p1, p0, Landroid/support/v7/widget/j;->h:Landroid/support/v7/widget/k;

    return-void
.end method

.method private static a(Landroid/content/Context;Landroid/support/v7/widget/AppCompatDrawableManager;I)Landroid/support/v7/widget/ad;
    .locals 0
    ...
    invoke-direct {p1}, Landroid/support/v7/widget/ad;-><init>()V

    const/4 p2, 0x1

    .line 380
    iput-boolean p2, p1, Landroid/support/v7/widget/ad;->d:Z

    .line 381
    iput-object p0, p1, Landroid/support/v7/widget/ad;->a:Landroid/content/res/ColorStateList;
...
.method private a(Landroid/content/Context;Landroid/support/v7/widget/TintTypedArray;)V
    ...
    iget v1, p0, Landroid/support/v7/widget/j;->i:I
    ...
    .line 284
    iput-boolean v2, p0, Landroid/support/v7/widget/j;->k:Z
    ...
    iput-object p1, p0, Landroid/support/v7/widget/j;->j:Landroid/graphics/Typeface;
    ...
    .line 246
    iput-object v0, p0, Landroid/support/v7/widget/j;->j:Landroid/graphics/Typeface;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/j;->a:Landroid/widget/TextView;
    ...
    invoke-direct {v3, p0, p1}, Landroid/support/v7/widget/j$1;-><init>(Landroid/support/v7/widget/j;Ljava/lang/ref/WeakReference;)V

    .line 265
    :try_start_0
    iget p1, p0, Landroid/support/v7/widget/j;->i:I
    ...
    .line 267
    iget-object p1, p0, Landroid/support/v7/widget/j;->j:Landroid/graphics/Typeface;
    ...
    :goto_3
    iput-boolean v1, p0, Landroid/support/v7/widget/j;->k:Z
    :try_end_0
    ...
    .line 276
    iget p2, p0, Landroid/support/v7/widget/j;->i:I
...
.method private a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/ad;)V
    .locals 1
    ...
    invoke-static {p1, p2, v0}, Landroid/support/v7/widget/AppCompatDrawableManager;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/ad;[I)V
...
.method private b(IF)V
    ...
    .line 418
    iget-object v0, p0, Landroid/support/v7/widget/j;->h:Landroid/support/v7/widget/k;

    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/k;->a(IF)V
...
.method a()V
    ...
    .line 352
    iget-object v0, p0, Landroid/support/v7/widget/j;->b:Landroid/support/v7/widget/ad;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/j;->c:Landroid/support/v7/widget/ad;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/j;->d:Landroid/support/v7/widget/ad;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/j;->e:Landroid/support/v7/widget/ad;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/j;->b:Landroid/support/v7/widget/ad;

    invoke-direct {p0, v3, v4}, Landroid/support/v7/widget/j;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/ad;)V
    ...
    iget-object v4, p0, Landroid/support/v7/widget/j;->c:Landroid/support/v7/widget/ad;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/j;->d:Landroid/support/v7/widget/ad;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/j;->e:Landroid/support/v7/widget/ad;

    invoke-direct {p0, v0, v3}, Landroid/support/v7/widget/j;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/ad;)V
    ...
    .line 361
    iget-object v0, p0, Landroid/support/v7/widget/j;->f:Landroid/support/v7/widget/ad;

    if-nez v0, :cond_2

    iget-object v0, p0, Landroid/support/v7/widget/j;->g:Landroid/support/v7/widget/ad;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/j;->f:Landroid/support/v7/widget/ad;

    invoke-direct {p0, v2, v3}, Landroid/support/v7/widget/j;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/ad;)V

    .line 364
    aget-object v0, v0, v1

    iget-object v1, p0, Landroid/support/v7/widget/j;->g:Landroid/support/v7/widget/ad;

    invoke-direct {p0, v0, v1}, Landroid/support/v7/widget/j;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/ad;)V
...
.method a(IF)V
    ...
    .line 399
    invoke-virtual {p0}, Landroid/support/v7/widget/j;->c()Z
    ...
    .line 400
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/j;->b(IF)V
...
.method a(IIII)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Landroid/support/v7/widget/k;->a(IIII)V
...
.method a(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/j;->a(Z)V
    ...
    .line 330
    iget-object v2, p0, Landroid/support/v7/widget/j;->a:Landroid/widget/TextView;
    ...
    .line 340
    :cond_2
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/j;->a(Landroid/content/Context;Landroid/support/v7/widget/TintTypedArray;)V
    ...
    .line 343
    iget-object p1, p0, Landroid/support/v7/widget/j;->a:Landroid/widget/TextView;

    iget-object p2, p0, Landroid/support/v7/widget/j;->j:Landroid/graphics/Typeface;

    iget v0, p0, Landroid/support/v7/widget/j;->i:I
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 71
    iget-object v3, v0, Landroid/support/v7/widget/j;->a:Landroid/widget/TextView;
    ...
    .line 80
    invoke-static {v3, v4, v9}, Landroid/support/v7/widget/j;->a(Landroid/content/Context;Landroid/support/v7/widget/AppCompatDrawableManager;I)Landroid/support/v7/widget/ad;

    move-result-object v9

    iput-object v9, v0, Landroid/support/v7/widget/j;->b:Landroid/support/v7/widget/ad;
    ...
    iput-object v9, v0, Landroid/support/v7/widget/j;->c:Landroid/support/v7/widget/ad;
    ...
    iput-object v9, v0, Landroid/support/v7/widget/j;->d:Landroid/support/v7/widget/ad;
    ...
    iput-object v9, v0, Landroid/support/v7/widget/j;->e:Landroid/support/v7/widget/ad;
    ...
    iput-object v9, v0, Landroid/support/v7/widget/j;->f:Landroid/support/v7/widget/ad;
    ...
    iput-object v4, v0, Landroid/support/v7/widget/j;->g:Landroid/support/v7/widget/ad;
    ...
    .line 112
    iget-object v4, v0, Landroid/support/v7/widget/j;->a:Landroid/widget/TextView;
    ...
    .line 128
    :goto_0
    invoke-direct {v0, v3, v7}, Landroid/support/v7/widget/j;->a(Landroid/content/Context;Landroid/support/v7/widget/TintTypedArray;)V
    ...
    .line 173
    iget-object v9, v0, Landroid/support/v7/widget/j;->a:Landroid/widget/TextView;
    ...
    .line 181
    iget-object v7, v0, Landroid/support/v7/widget/j;->a:Landroid/widget/TextView;
    ...
    .line 190
    invoke-virtual {v0, v12}, Landroid/support/v7/widget/j;->a(Z)V

    .line 192
    :cond_14
    iget-object v4, v0, Landroid/support/v7/widget/j;->j:Landroid/graphics/Typeface;
    ...
    iget-object v5, v0, Landroid/support/v7/widget/j;->j:Landroid/graphics/Typeface;

    iget v7, v0, Landroid/support/v7/widget/j;->i:I

    invoke-virtual {v4, v5, v7}, Landroid/widget/TextView;->setTypeface(Landroid/graphics/Typeface;I)V

    .line 196
    :cond_15
    iget-object v4, v0, Landroid/support/v7/widget/j;->h:Landroid/support/v7/widget/k;

    invoke-virtual {v4, v1, v2}, Landroid/support/v7/widget/k;->a(Landroid/util/AttributeSet;I)V
    ...
    .line 200
    iget-object v2, v0, Landroid/support/v7/widget/j;->h:Landroid/support/v7/widget/k;

    invoke-virtual {v2}, Landroid/support/v7/widget/k;->a()I
    ...
    .line 203
    invoke-virtual {v2}, Landroid/support/v7/widget/k;->e()[I
    ...
    .line 208
    iget-object v2, v0, Landroid/support/v7/widget/j;->a:Landroid/widget/TextView;

    iget-object v4, v0, Landroid/support/v7/widget/j;->h:Landroid/support/v7/widget/k;

    .line 209
    invoke-virtual {v4}, Landroid/support/v7/widget/k;->c()I

    move-result v4

    iget-object v5, v0, Landroid/support/v7/widget/j;->h:Landroid/support/v7/widget/k;

    .line 210
    invoke-virtual {v5}, Landroid/support/v7/widget/k;->d()I

    move-result v5

    iget-object v7, v0, Landroid/support/v7/widget/j;->h:Landroid/support/v7/widget/k;

    .line 211
    invoke-virtual {v7}, Landroid/support/v7/widget/k;->b()I
    ...
    .line 231
    iget-object v1, v0, Landroid/support/v7/widget/j;->a:Landroid/widget/TextView;
...
.method a(Ljava/lang/ref/WeakReference;Landroid/graphics/Typeface;)V
    ...
    .line 305
    iput-object p2, p0, Landroid/support/v7/widget/j;->j:Landroid/graphics/Typeface;
...
.method a(ZIIII)V
    ...
    .line 391
    invoke-virtual {p0}, Landroid/support/v7/widget/j;->b()V
...
.method a([II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/k;->a([II)V
...
.method g()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/k;->d()I
...
.method h()[I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/k;->e()[I
