...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->p:Ljava/util/List;
...
.method public constructor <init>(Landroid/view/View;)V
    ...
    .line 10694
    iput-wide v1, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->d:J

    .line 10695
    iput v0, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->e:I
    ...
    .line 10699
    iput-object v1, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->g:Landroid/support/v7/widget/RecyclerView$ViewHolder;

    .line 10701
    iput-object v1, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->h:Landroid/support/v7/widget/RecyclerView$ViewHolder;

    .line 10806
    iput-object v1, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->j:Ljava/util/List;

    .line 10807
    iput-object v1, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->k:Ljava/util/List;

    const/4 v2, 0x0

    .line 10809
    iput v2, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->q:I

    .line 10813
    iput-object v1, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->l:Landroid/support/v7/widget/RecyclerView$Recycler;

    .line 10815
    iput-boolean v2, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->m:Z

    .line 10819
    iput v2, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->r:I
...
.method a(II)V
    ...
    iput p1, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->i:I
...
.method a(IZ)V
    ...
    .line 10852
    iget p2, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->f:I

    add-int/2addr p2, p1

    iput p2, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->f:I

    .line 10854
    :cond_2
    iget p2, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->b:I

    add-int/2addr p2, p1

    iput p2, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->b:I
...
.method a(Landroid/support/v7/widget/RecyclerView$Recycler;Z)V
    ...
    .line 11000
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->l:Landroid/support/v7/widget/RecyclerView$Recycler;

    .line 11001
    iput-boolean p2, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->m:Z
...
.method a(Ljava/lang/Object;)V
    ...
    .line 11043
    :cond_0
    iget v1, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->i:I
    ...
    .line 11044
    invoke-direct {p0}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->v()V
...
.method b(Landroid/support/v7/widget/RecyclerView;)V
    ...
    .line 11113
    iput p1, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->r:I
...
.method d()Z
    ...
    .line 10976
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->l:Landroid/support/v7/widget/RecyclerView$Recycler;
...
.method public final getAdapterPosition()I
    ...
    .line 10937
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->o:Landroid/support/v7/widget/RecyclerView;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v7/widget/RecyclerView;->d(Landroid/support/v7/widget/RecyclerView$ViewHolder;)I
...
.method q()Ljava/util/List;
    ...
    :cond_1
    :goto_0
    sget-object v0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->p:Ljava/util/List;
...
.method r()V
    ...
    .line 11079
    iput v1, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->b:I

    .line 11080
    iput v1, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->c:I

    const-wide/16 v2, -0x1

    .line 11081
    iput-wide v2, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->d:J

    .line 11082
    iput v1, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->f:I
    ...
    .line 11088
    iput v1, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->n:I

    .line 11089
    invoke-static {p0}, Landroid/support/v7/widget/RecyclerView;->c(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
...
.method public final setIsRecyclable(Z)V
    ...
    :goto_0
    iput v1, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->q:I
    ...
    .line 11155
    iput p1, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->q:I
    ...
    .line 11163
    iget p1, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->i:I
    ...
    .line 11164
    iget p1, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->q:I
...
.method public toString()Ljava/lang/String;
    ...
    .line 11121
    invoke-virtual {p0}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->d()Z
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->m:Z
    ...
    iget v2, p0, Landroid/support/v7/widget/RecyclerView$ViewHolder;->q:I
