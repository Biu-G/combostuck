...
.field private final g:Landroid/support/v7/view/menu/MenuBuilder;

.field private final h:Landroid/support/v7/view/menu/MenuAdapter;
...
.method static constructor <clinit>()V
    ...
    sput v0, Landroid/support/v7/view/menu/g;->e:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/MenuBuilder;Landroid/view/View;IIZ)V
    ...
    .line 117
    invoke-direct {p0}, Landroid/support/v7/view/menu/e;-><init>()V

    .line 60
    new-instance v0, Landroid/support/v7/view/menu/g$1;

    invoke-direct {v0, p0}, Landroid/support/v7/view/menu/g$1;-><init>(Landroid/support/v7/view/menu/g;)V

    iput-object v0, p0, Landroid/support/v7/view/menu/g;->b:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;

    .line 79
    new-instance v0, Landroid/support/v7/view/menu/g$2;

    invoke-direct {v0, p0}, Landroid/support/v7/view/menu/g$2;-><init>(Landroid/support/v7/view/menu/g;)V
    ...
    .line 112
    iput v0, p0, Landroid/support/v7/view/menu/g;->t:I

    .line 118
    iput-object p1, p0, Landroid/support/v7/view/menu/g;->f:Landroid/content/Context;

    .line 119
    iput-object p2, p0, Landroid/support/v7/view/menu/g;->g:Landroid/support/v7/view/menu/MenuBuilder;

    .line 120
    iput-boolean p6, p0, Landroid/support/v7/view/menu/g;->i:Z
    ...
    iget-boolean v1, p0, Landroid/support/v7/view/menu/g;->i:Z

    sget v2, Landroid/support/v7/view/menu/g;->e:I
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/g;->h:Landroid/support/v7/view/menu/MenuAdapter;

    .line 123
    iput p4, p0, Landroid/support/v7/view/menu/g;->k:I

    .line 124
    iput p5, p0, Landroid/support/v7/view/menu/g;->l:I
    ...
    iput p4, p0, Landroid/support/v7/view/menu/g;->j:I

    .line 130
    iput-object p3, p0, Landroid/support/v7/view/menu/g;->o:Landroid/view/View;

    .line 132
    new-instance p3, Landroid/support/v7/widget/MenuPopupWindow;

    iget-object p4, p0, Landroid/support/v7/view/menu/g;->f:Landroid/content/Context;

    iget p5, p0, Landroid/support/v7/view/menu/g;->k:I

    iget p6, p0, Landroid/support/v7/view/menu/g;->l:I
    ...
    iput-object p3, p0, Landroid/support/v7/view/menu/g;->a:Landroid/support/v7/widget/MenuPopupWindow;
...
.method private c()Z
    ...
    .line 159
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->a:Landroid/support/v7/widget/MenuPopupWindow;
    ...
    .line 164
    iget-object v3, p0, Landroid/support/v7/view/menu/g;->d:Landroid/view/ViewTreeObserver;
    ...
    iput-object v4, p0, Landroid/support/v7/view/menu/g;->d:Landroid/view/ViewTreeObserver;
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/g;->b:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;

    invoke-virtual {v3, v4}, Landroid/view/ViewTreeObserver;->addOnGlobalLayoutListener(Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    .line 169
    :cond_3
    iget-object v3, p0, Landroid/support/v7/view/menu/g;->m:Landroid/view/View$OnAttachStateChangeListener;

    invoke-virtual {v0, v3}, Landroid/view/View;->addOnAttachStateChangeListener(Landroid/view/View$OnAttachStateChangeListener;)V

    .line 170
    iget-object v3, p0, Landroid/support/v7/view/menu/g;->a:Landroid/support/v7/widget/MenuPopupWindow;
    ...
    iget v3, p0, Landroid/support/v7/view/menu/g;->t:I
    ...
    .line 174
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->h:Landroid/support/v7/view/menu/MenuAdapter;

    iget-object v4, p0, Landroid/support/v7/view/menu/g;->f:Landroid/content/Context;

    iget v5, p0, Landroid/support/v7/view/menu/g;->j:I

    invoke-static {v0, v3, v4, v5}, Landroid/support/v7/view/menu/g;->a(Landroid/widget/ListAdapter;Landroid/view/ViewGroup;Landroid/content/Context;I)I
    ...
    iget v4, p0, Landroid/support/v7/view/menu/g;->s:I
    ...
    invoke-virtual {p0}, Landroid/support/v7/view/menu/g;->b()Landroid/graphics/Rect;
    ...
    .line 186
    iget-boolean v4, p0, Landroid/support/v7/view/menu/g;->u:Z

    if-eqz v4, :cond_6

    iget-object v4, p0, Landroid/support/v7/view/menu/g;->g:Landroid/support/v7/view/menu/MenuBuilder;
    ...
    .line 192
    iget-object v6, p0, Landroid/support/v7/view/menu/g;->g:Landroid/support/v7/view/menu/MenuBuilder;
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/g;->h:Landroid/support/v7/view/menu/MenuAdapter;
...
.method public a(Landroid/view/View;)V
    ...
    .line 325
    iput-object p1, p0, Landroid/support/v7/view/menu/g;->o:Landroid/view/View;
...
.method public a(Landroid/widget/PopupWindow$OnDismissListener;)V
    ...
    .line 339
    iput-object p1, p0, Landroid/support/v7/view/menu/g;->n:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public onCloseMenu(Landroid/support/v7/view/menu/MenuBuilder;Z)V
    ...
    .line 301
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->g:Landroid/support/v7/view/menu/MenuBuilder;
    ...
    .line 304
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->p:Landroid/support/v7/view/menu/MenuPresenter$Callback;
...
.method public onDismiss()V
    ...
    .line 235
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->d:Landroid/view/ViewTreeObserver;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/g;->d:Landroid/view/ViewTreeObserver;

    .line 237
    :cond_0
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->d:Landroid/view/ViewTreeObserver;

    iget-object v1, p0, Landroid/support/v7/view/menu/g;->b:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    .line 242
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->n:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public onSubMenuSelected(Landroid/support/v7/view/menu/SubMenuBuilder;)Z
    ...
    iget-object v3, p0, Landroid/support/v7/view/menu/g;->f:Landroid/content/Context;

    iget-object v5, p0, Landroid/support/v7/view/menu/g;->c:Landroid/view/View;

    iget-boolean v6, p0, Landroid/support/v7/view/menu/g;->i:Z

    iget v7, p0, Landroid/support/v7/view/menu/g;->k:I

    iget v8, p0, Landroid/support/v7/view/menu/g;->l:I
    ...
    .line 266
    iget-object v2, p0, Landroid/support/v7/view/menu/g;->p:Landroid/support/v7/view/menu/MenuPresenter$Callback;
    ...
    .line 267
    invoke-static {p1}, Landroid/support/v7/view/menu/e;->b(Landroid/support/v7/view/menu/MenuBuilder;)Z
    ...
    .line 270
    iget-object v2, p0, Landroid/support/v7/view/menu/g;->n:Landroid/widget/PopupWindow$OnDismissListener;
    ...
    .line 271
    iput-object v2, p0, Landroid/support/v7/view/menu/g;->n:Landroid/widget/PopupWindow$OnDismissListener;

    .line 274
    iget-object v2, p0, Landroid/support/v7/view/menu/g;->g:Landroid/support/v7/view/menu/MenuBuilder;

    invoke-virtual {v2, v1}, Landroid/support/v7/view/menu/MenuBuilder;->close(Z)V

    .line 277
    iget-object v2, p0, Landroid/support/v7/view/menu/g;->a:Landroid/support/v7/widget/MenuPopupWindow;
    ...
    .line 282
    iget v4, p0, Landroid/support/v7/view/menu/g;->t:I
    ...
    .line 285
    iget-object v4, p0, Landroid/support/v7/view/menu/g;->o:Landroid/view/View;
...
.method public setCallback(Landroid/support/v7/view/menu/MenuPresenter$Callback;)V
    ...
    .line 258
    iput-object p1, p0, Landroid/support/v7/view/menu/g;->p:Landroid/support/v7/view/menu/MenuPresenter$Callback;
...
.method public show()V
    ...
    .line 208
    invoke-direct {p0}, Landroid/support/v7/view/menu/g;->c()Z
...
.method public updateMenuView(Z)V
    ...
    .line 251
    iget-object p1, p0, Landroid/support/v7/view/menu/g;->h:Landroid/support/v7/view/menu/MenuAdapter;
