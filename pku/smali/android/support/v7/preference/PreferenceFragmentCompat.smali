...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/support/v7/preference/PreferenceFragmentCompat$a;,
        Landroid/support/v7/preference/PreferenceFragmentCompat$b;,
...
.field private final g:Landroid/support/v7/preference/PreferenceFragmentCompat$a;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->f:I

    .line 137
    new-instance v0, Landroid/support/v7/preference/PreferenceFragmentCompat$a;

    invoke-direct {v0, p0}, Landroid/support/v7/preference/PreferenceFragmentCompat$a;-><init>(Landroid/support/v7/preference/PreferenceFragmentCompat;)V

    iput-object v0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->g:Landroid/support/v7/preference/PreferenceFragmentCompat$a;
    ...
    iput-object v0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->h:Landroid/os/Handler;
    ...
    iput-object v0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->i:Ljava/lang/Runnable;
...
.method private a(Landroid/support/v7/preference/Preference;Ljava/lang/String;)V
    ...
    .line 711
    iget-object p1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->a:Landroid/support/v7/widget/RecyclerView;

    if-nez p1, :cond_0

    .line 712
    iput-object v0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->j:Ljava/lang/Runnable;
...
.method private b()V
    ...
    .line 521
    iget-object v0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->b:Landroid/support/v7/preference/PreferenceManager;
...
.method private c()V
    ...
    .line 527
    iget-object v0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->h:Landroid/os/Handler;
...
.method public addPreferencesFromResource(I)V
    ...
    .line 427
    invoke-direct {p0}, Landroid/support/v7/preference/PreferenceFragmentCompat;->b()V

    .line 429
    iget-object v0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->b:Landroid/support/v7/preference/PreferenceManager;

    iget-object v1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->e:Landroid/content/Context;
...
.method public final getListView()Landroid/support/v7/widget/RecyclerView;
    ...
    .line 560
    iget-object v0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->a:Landroid/support/v7/widget/RecyclerView;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->e:Landroid/content/Context;
    ...
    iput-object v0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->b:Landroid/support/v7/preference/PreferenceManager;
...
.method public onCreateRecyclerView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/support/v7/widget/RecyclerView;
    ...
    .line 580
    iget-object p3, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->e:Landroid/content/Context;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 247
    iget-object v0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->e:Landroid/content/Context;
    ...
    iget v2, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->f:I

    invoke-virtual {v0, v1, v2}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v1

    iput v1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->f:I
    ...
    .line 266
    iget v0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->f:I
    ...
    .line 282
    iput-object p1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->a:Landroid/support/v7/widget/RecyclerView;

    .line 284
    iget-object p3, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->g:Landroid/support/v7/preference/PreferenceFragmentCompat$a;
    ...
    .line 289
    :cond_0
    iget-object p1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->g:Landroid/support/v7/preference/PreferenceFragmentCompat$a;

    invoke-virtual {p1, v5}, Landroid/support/v7/preference/PreferenceFragmentCompat$a;->a(Z)V
    ...
    .line 296
    :cond_1
    iget-object p1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->h:Landroid/os/Handler;

    iget-object p3, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->i:Ljava/lang/Runnable;
...
.method public onDestroyView()V
    ...
    iget-object v1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->i:Ljava/lang/Runnable;
    ...
    .line 368
    iget-boolean v0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->c:Z

    if-eqz v0, :cond_0

    .line 369
    invoke-direct {p0}, Landroid/support/v7/preference/PreferenceFragmentCompat;->d()V

    :cond_0
    const/4 v0, 0x0

    .line 371
    iput-object v0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->a:Landroid/support/v7/widget/RecyclerView;
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    .line 339
    :cond_0
    iget-boolean p1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->c:Z

    if-eqz p1, :cond_1

    .line 340
    invoke-virtual {p0}, Landroid/support/v7/preference/PreferenceFragmentCompat;->a()V

    .line 341
    iget-object p1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->j:Ljava/lang/Runnable;
    ...
    .line 343
    iput-object p1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->j:Ljava/lang/Runnable;

    :cond_1
    const/4 p1, 0x1

    .line 347
    iput-boolean p1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->d:Z
...
.method public scrollToPreference(Landroid/support/v7/preference/Preference;)V
    ...
    .line 676
    invoke-direct {p0, p1, v0}, Landroid/support/v7/preference/PreferenceFragmentCompat;->a(Landroid/support/v7/preference/Preference;Ljava/lang/String;)V
...
.method public scrollToPreference(Ljava/lang/String;)V
    ...
    .line 672
    invoke-direct {p0, v0, p1}, Landroid/support/v7/preference/PreferenceFragmentCompat;->a(Landroid/support/v7/preference/Preference;Ljava/lang/String;)V
...
.method public setDivider(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 311
    iget-object v0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->g:Landroid/support/v7/preference/PreferenceFragmentCompat$a;

    invoke-virtual {v0, p1}, Landroid/support/v7/preference/PreferenceFragmentCompat$a;->a(Landroid/graphics/drawable/Drawable;)V
...
.method public setDividerHeight(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/preference/PreferenceFragmentCompat$a;->a(I)V
...
.method public setPreferenceScreen(Landroid/support/v7/preference/PreferenceScreen;)V
    ...
    .line 403
    iput-boolean p1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->c:Z

    .line 404
    iget-boolean p1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->d:Z

    if-eqz p1, :cond_0

    .line 405
    invoke-direct {p0}, Landroid/support/v7/preference/PreferenceFragmentCompat;->c()V
