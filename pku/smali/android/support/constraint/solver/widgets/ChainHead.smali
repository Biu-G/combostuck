...
.method public constructor <init>(Landroid/support/constraint/solver/widgets/ConstraintWidget;IZ)V
    ...
    .line 44
    iput-boolean v0, p0, Landroid/support/constraint/solver/widgets/ChainHead;->b:Z
    ...
    .line 60
    iput p2, p0, Landroid/support/constraint/solver/widgets/ChainHead;->a:I

    .line 61
    iput-boolean p3, p0, Landroid/support/constraint/solver/widgets/ChainHead;->b:Z
...
.method private a()V
    ...
    .line 79
    iget v0, p0, Landroid/support/constraint/solver/widgets/ChainHead;->a:I
    ...
    iget v8, p0, Landroid/support/constraint/solver/widgets/ChainHead;->a:I
    ...
    iget-object v7, v3, Landroid/support/constraint/solver/widgets/ConstraintWidget;->e:[I
    ...
    .line 103
    iget-object v7, v3, Landroid/support/constraint/solver/widgets/ConstraintWidget;->P:[F
    ...
    iget-object v11, v3, Landroid/support/constraint/solver/widgets/ConstraintWidget;->P:[F

    iget v12, p0, Landroid/support/constraint/solver/widgets/ChainHead;->a:I
    ...
    .line 108
    :cond_2
    iget v10, p0, Landroid/support/constraint/solver/widgets/ChainHead;->a:I
    ...
    iget v7, p0, Landroid/support/constraint/solver/widgets/ChainHead;->a:I
    ...
    iget-boolean v0, p0, Landroid/support/constraint/solver/widgets/ChainHead;->b:Z
...
.method private static a(Landroid/support/constraint/solver/widgets/ConstraintWidget;I)Z
    ...
    iget-object v0, p0, Landroid/support/constraint/solver/widgets/ConstraintWidget;->e:[I

    aget v0, v0, p1

    if-eqz v0, :cond_0

    iget-object p0, p0, Landroid/support/constraint/solver/widgets/ConstraintWidget;->e:[I
...
.method public define()V
    ...
    .line 195
    iget-boolean v0, p0, Landroid/support/constraint/solver/widgets/ChainHead;->c:Z

    if-nez v0, :cond_0

    .line 196
    invoke-direct {p0}, Landroid/support/constraint/solver/widgets/ChainHead;->a()V

    :cond_0
    const/4 v0, 0x1

    .line 198
    iput-boolean v0, p0, Landroid/support/constraint/solver/widgets/ChainHead;->c:Z
