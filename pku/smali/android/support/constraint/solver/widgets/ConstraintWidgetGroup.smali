...
.method constructor <init>(Ljava/util/List;)V
    ...
    .line 38
    iput v0, p0, Landroid/support/constraint/solver/widgets/ConstraintWidgetGroup;->a:I
    ...
    iget v2, p0, Landroid/support/constraint/solver/widgets/ConstraintWidgetGroup;->a:I

    aput v2, v1, v0

    iget v0, p0, Landroid/support/constraint/solver/widgets/ConstraintWidgetGroup;->b:I
    ...
    iput-object v0, p0, Landroid/support/constraint/solver/widgets/ConstraintWidgetGroup;->c:Ljava/util/List;
    ...
    iput-object v0, p0, Landroid/support/constraint/solver/widgets/ConstraintWidgetGroup;->d:Ljava/util/List;
    ...
    iput-object v0, p0, Landroid/support/constraint/solver/widgets/ConstraintWidgetGroup;->e:Ljava/util/HashSet;
    ...
    iput-object v0, p0, Landroid/support/constraint/solver/widgets/ConstraintWidgetGroup;->h:Ljava/util/List;
...
.method private a(Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    .line 174
    iget-boolean v0, p1, Landroid/support/constraint/solver/widgets/ConstraintWidget;->I:Z
    ...
    .line 186
    :cond_2
    iget-object v3, p1, Landroid/support/constraint/solver/widgets/ConstraintWidget;->q:Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    iget-boolean v4, v4, Landroid/support/constraint/solver/widgets/ConstraintWidget;->J:Z
    ...
    iget-boolean v1, v1, Landroid/support/constraint/solver/widgets/ConstraintWidget;->J:Z
    ...
    .line 215
    iput-boolean v2, p1, Landroid/support/constraint/solver/widgets/ConstraintWidget;->J:Z
...
.method private a(Ljava/util/ArrayList;Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    .line 122
    iget-boolean v0, p2, Landroid/support/constraint/solver/widgets/ConstraintWidget;->K:Z
    ...
    .line 126
    iput-boolean v0, p2, Landroid/support/constraint/solver/widgets/ConstraintWidget;->K:Z
...
.method a()Ljava/util/List;
    ...
    .line 99
    iget-object v0, p0, Landroid/support/constraint/solver/widgets/ConstraintWidgetGroup;->g:Ljava/util/List;
    ...
    .line 105
    iget-boolean v3, v2, Landroid/support/constraint/solver/widgets/ConstraintWidget;->I:Z

    if-nez v3, :cond_1

    .line 106
    iget-object v3, p0, Landroid/support/constraint/solver/widgets/ConstraintWidgetGroup;->g:Ljava/util/List;
    ...
    .line 109
    :cond_2
    iget-object v0, p0, Landroid/support/constraint/solver/widgets/ConstraintWidgetGroup;->h:Ljava/util/List;
    ...
    iget-object v1, p0, Landroid/support/constraint/solver/widgets/ConstraintWidgetGroup;->g:Ljava/util/List;
...
.method a(I)Ljava/util/Set;
    ...
    .line 75
    iget-object p1, p0, Landroid/support/constraint/solver/widgets/ConstraintWidgetGroup;->e:Ljava/util/HashSet;
    ...
    .line 77
    iget-object p1, p0, Landroid/support/constraint/solver/widgets/ConstraintWidgetGroup;->f:Ljava/util/HashSet;
...
.method a(Landroid/support/constraint/solver/widgets/ConstraintWidget;I)V
    ...
    .line 84
    iget-object p2, p0, Landroid/support/constraint/solver/widgets/ConstraintWidgetGroup;->e:Ljava/util/HashSet;
...
.method b()V
    ...
    .line 160
    iget-object v2, p0, Landroid/support/constraint/solver/widgets/ConstraintWidgetGroup;->h:Ljava/util/List;
...
.method public getStartWidgets(I)Ljava/util/List;
    ...
    .line 66
    iget-object p1, p0, Landroid/support/constraint/solver/widgets/ConstraintWidgetGroup;->c:Ljava/util/List;
    ...
    .line 68
    iget-object p1, p0, Landroid/support/constraint/solver/widgets/ConstraintWidgetGroup;->d:Ljava/util/List;
