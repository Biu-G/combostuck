...
.method public constructor <init>(Ljava/util/concurrent/Executor;)V
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/ComputableLiveData;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/ComputableLiveData;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/ComputableLiveData;->a:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/ComputableLiveData;->b:Ljava/lang/Runnable;

    .line 65
    iput-object p1, p0, Landroid/arch/lifecycle/ComputableLiveData;->c:Ljava/util/concurrent/Executor;
    ...
    iput-object p1, p0, Landroid/arch/lifecycle/ComputableLiveData;->d:Landroid/arch/lifecycle/LiveData;
...
.method static synthetic a(Landroid/arch/lifecycle/ComputableLiveData;)Ljava/util/concurrent/Executor;
    ...
    .line 41
    iget-object p0, p0, Landroid/arch/lifecycle/ComputableLiveData;->c:Ljava/util/concurrent/Executor;
...
.method static synthetic b(Landroid/arch/lifecycle/ComputableLiveData;)Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 41
    iget-object p0, p0, Landroid/arch/lifecycle/ComputableLiveData;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static synthetic c(Landroid/arch/lifecycle/ComputableLiveData;)Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 41
    iget-object p0, p0, Landroid/arch/lifecycle/ComputableLiveData;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static synthetic d(Landroid/arch/lifecycle/ComputableLiveData;)Landroid/arch/lifecycle/LiveData;
    ...
    .line 41
    iget-object p0, p0, Landroid/arch/lifecycle/ComputableLiveData;->d:Landroid/arch/lifecycle/LiveData;
...
.method public getLiveData()Landroid/arch/lifecycle/LiveData;
    ...
    .line 82
    iget-object v0, p0, Landroid/arch/lifecycle/ComputableLiveData;->d:Landroid/arch/lifecycle/LiveData;
...
.method public invalidate()V
    ...
    iget-object v1, p0, Landroid/arch/lifecycle/ComputableLiveData;->b:Ljava/lang/Runnable;
