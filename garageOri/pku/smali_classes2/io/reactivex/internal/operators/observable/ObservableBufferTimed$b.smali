...
.method constructor <init>(Lio/reactivex/Observer;Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)V
    ...
    .line 98
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->b:Ljava/util/concurrent/Callable;

    .line 99
    iput-wide p3, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->c:J

    .line 100
    iput-object p5, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->d:Ljava/util/concurrent/TimeUnit;

    .line 101
    iput-object p6, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->e:Lio/reactivex/Scheduler;
...
.method public a(Lio/reactivex/Observer;Ljava/util/Collection;)V
    ...
    .line 213
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->actual:Lio/reactivex/Observer;
...
.method public onComplete()V
    ...
    .line 161
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->queue:Lio/reactivex/internal/fuseable/SimplePlainQueue;
    ...
    .line 162
    iput-boolean v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->done:Z

    .line 163
    invoke-virtual {p0}, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->enter()Z
    ...
    .line 164
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->queue:Lio/reactivex/internal/fuseable/SimplePlainQueue;

    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->actual:Lio/reactivex/Observer;
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    .line 149
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->actual:Lio/reactivex/Observer;
...
.method public onSubscribe(Lio/reactivex/disposables/Disposable;)V
    ...
    .line 112
    :try_start_0
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->b:Ljava/util/concurrent/Callable;
    ...
    .line 124
    iget-boolean p1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->cancelled:Z

    if-nez p1, :cond_0

    .line 125
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->e:Lio/reactivex/Scheduler;

    iget-wide v2, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->c:J

    iget-wide v4, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->c:J

    iget-object v6, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->d:Ljava/util/concurrent/TimeUnit;
...
.method public run()V
    ...
    .line 186
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->b:Ljava/util/concurrent/Callable;
    ...
    .line 208
    invoke-virtual {p0, v1, v0, p0}, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->fastPathEmit(Ljava/lang/Object;ZLio/reactivex/disposables/Disposable;)V
    ...
    .line 189
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->actual:Lio/reactivex/Observer;
