...
.method constructor <init>(Lio/reactivex/Observer;JJLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler$Worker;I)V
    ...
    .line 539
    iput-wide p2, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->b:J

    .line 540
    iput-wide p4, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->c:J

    .line 541
    iput-object p6, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->d:Ljava/util/concurrent/TimeUnit;

    .line 542
    iput-object p7, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->e:Lio/reactivex/Scheduler$Worker;
...
.method a()V
    ...
    .line 621
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->e:Lio/reactivex/Scheduler$Worker;
...
.method a(Lio/reactivex/subjects/UnicastSubject;)V
    ...
    .line 625
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->queue:Lio/reactivex/internal/fuseable/SimplePlainQueue;
    ...
    .line 626
    invoke-virtual {p0}, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->enter()Z
...
.method b()V
    ...
    .line 634
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->actual:Lio/reactivex/Observer;
    ...
    .line 644
    invoke-virtual {p0}, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->a()V
    ...
    .line 650
    :cond_1
    iget-boolean v5, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->done:Z
    ...
    .line 659
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->error:Ljava/lang/Throwable;
    ...
    .line 705
    invoke-virtual {p0, v4}, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->leave(I)I
    ...
    .line 682
    iget-boolean v5, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->cancelled:Z
    ...
    .line 690
    iget-object v6, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->e:Lio/reactivex/Scheduler$Worker;
    ...
    iget-object v5, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->d:Ljava/util/concurrent/TimeUnit;
...
.method public dispose()V
    ...
    .line 612
    iput-boolean v0, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->cancelled:Z
...
.method public isDisposed()Z
    ...
    .line 617
    iget-boolean v0, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->cancelled:Z
...
.method public onComplete()V
    ...
    .line 601
    iput-boolean v0, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->done:Z
    ...
    .line 606
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->actual:Lio/reactivex/Observer;
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    .line 589
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->error:Ljava/lang/Throwable;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 571
    invoke-virtual {p0}, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->fastEnter()Z
    ...
    .line 575
    invoke-virtual {p0, p1}, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->leave(I)I
...
.method public onSubscribe(Lio/reactivex/disposables/Disposable;)V
    ...
    .line 552
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->actual:Lio/reactivex/Observer;

    invoke-interface {p1, p0}, Lio/reactivex/Observer;->onSubscribe(Lio/reactivex/disposables/Disposable;)V

    .line 554
    iget-boolean p1, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->cancelled:Z
    ...
    iget-wide v2, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->b:J

    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->d:Ljava/util/concurrent/TimeUnit;
    ...
    .line 564
    iget-object v4, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->e:Lio/reactivex/Scheduler$Worker;

    iget-wide v6, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->c:J

    iget-wide v8, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->c:J

    iget-object v10, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$c;->d:Ljava/util/concurrent/TimeUnit;
