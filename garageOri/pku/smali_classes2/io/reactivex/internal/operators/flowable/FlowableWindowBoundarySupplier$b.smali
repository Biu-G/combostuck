...
# static fields
.field static final d:Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->d:Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$a;
    ...
    sput-object v0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->j:Ljava/lang/Object;
...
.method constructor <init>(Lorg/reactivestreams/Subscriber;ILjava/util/concurrent/Callable;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->e:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->k:Ljava/util/concurrent/atomic/AtomicLong;
...
.method a()V
    ...
    sget-object v1, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->d:Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$a;
...
.method a(Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$a;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object v0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->j:Ljava/lang/Object;

    invoke-virtual {p1, v0}, Lio/reactivex/internal/queue/MpscLinkedQueue;->offer(Ljava/lang/Object;)Z

    .line 166
    invoke-virtual {p0}, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->c()V
...
.method a(Ljava/lang/Throwable;)V
    ...
    .line 170
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->l:Lorg/reactivestreams/Subscription;
    ...
    .line 172
    iput-boolean p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->m:Z
...
.method b()V
    ...
    .line 181
    iput-boolean v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->m:Z
...
.method c()V
    ...
    .line 187
    invoke-virtual {p0}, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->getAndIncrement()I
    ...
    .line 195
    iget-wide v3, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->o:J
    ...
    :cond_1
    :goto_0
    iget-object v7, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->e:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 202
    iput-object v8, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->n:Lio/reactivex/processors/UnicastProcessor;

    return-void

    .line 206
    :cond_2
    iget-object v7, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->n:Lio/reactivex/processors/UnicastProcessor;

    .line 208
    iget-boolean v9, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->m:Z
    ...
    .line 291
    iput-wide v3, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->o:J

    neg-int v6, v6

    .line 292
    invoke-virtual {p0, v6}, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->addAndGet(I)I
    ...
    .line 247
    :cond_a
    sget-object v9, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->j:Ljava/lang/Object;
    ...
    .line 258
    iget-object v7, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->k:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 260
    iput-object v7, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->n:Lio/reactivex/processors/UnicastProcessor;

    .line 261
    iget-object v9, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->e:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 270
    iput-boolean v5, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->m:Z

    goto/16 :goto_0

    .line 283
    :cond_d
    iget-object v7, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->l:Lorg/reactivestreams/Subscription;
...
.method public cancel()V
    ...
    .line 137
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->e:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public onSubscribe(Lorg/reactivestreams/Subscription;)V
    ...
    .line 101
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->l:Lorg/reactivestreams/Subscription;
    ...
    sget-object v1, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->j:Ljava/lang/Object;
...
.method public request(J)V
    ...
    .line 145
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$b;->k:Ljava/util/concurrent/atomic/AtomicLong;
