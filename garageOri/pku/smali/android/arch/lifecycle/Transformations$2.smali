...
.method constructor <init>(Landroid/arch/core/util/Function;Landroid/arch/lifecycle/MediatorLiveData;)V
    ...
    .line 128
    iput-object p1, p0, Landroid/arch/lifecycle/Transformations$2;->b:Landroid/arch/core/util/Function;

    iput-object p2, p0, Landroid/arch/lifecycle/Transformations$2;->c:Landroid/arch/lifecycle/MediatorLiveData;
...
.method public onChanged(Ljava/lang/Object;)V
    ...
    .line 133
    iget-object v0, p0, Landroid/arch/lifecycle/Transformations$2;->b:Landroid/arch/core/util/Function;
    ...
    .line 134
    iget-object v0, p0, Landroid/arch/lifecycle/Transformations$2;->a:Landroid/arch/lifecycle/LiveData;
    ...
    .line 138
    iget-object v0, p0, Landroid/arch/lifecycle/Transformations$2;->c:Landroid/arch/lifecycle/MediatorLiveData;

    iget-object v1, p0, Landroid/arch/lifecycle/Transformations$2;->a:Landroid/arch/lifecycle/LiveData;

    invoke-virtual {v0, v1}, Landroid/arch/lifecycle/MediatorLiveData;->removeSource(Landroid/arch/lifecycle/LiveData;)V

    .line 140
    :cond_1
    iput-object p1, p0, Landroid/arch/lifecycle/Transformations$2;->a:Landroid/arch/lifecycle/LiveData;

    .line 141
    iget-object p1, p0, Landroid/arch/lifecycle/Transformations$2;->a:Landroid/arch/lifecycle/LiveData;

    if-eqz p1, :cond_2

    .line 142
    iget-object p1, p0, Landroid/arch/lifecycle/Transformations$2;->c:Landroid/arch/lifecycle/MediatorLiveData;
