...
.method constructor <init>(Landroid/support/v4/app/NotificationCompat$Builder;)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/h;->e:Ljava/util/List;
    ...
    iput-object v0, p0, Landroid/support/v4/app/h;->f:Landroid/os/Bundle;

    .line 63
    iput-object p1, p0, Landroid/support/v4/app/h;->b:Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    iput-object v0, p0, Landroid/support/v4/app/h;->a:Landroid/app/Notification$Builder;
    ...
    .line 70
    iget-object v2, p0, Landroid/support/v4/app/h;->a:Landroid/app/Notification$Builder;
    ...
    .line 99
    invoke-direct {p0, v6}, Landroid/support/v4/app/h;->a(Landroid/support/v4/app/NotificationCompat$Action;)V
    ...
    .line 103
    iget-object v2, p0, Landroid/support/v4/app/h;->f:Landroid/os/Bundle;

    iget-object v6, p1, Landroid/support/v4/app/NotificationCompat$Builder;->z:Landroid/os/Bundle;
    ...
    iget-object v8, p1, Landroid/support/v4/app/NotificationCompat$Builder;->s:Ljava/lang/String;
    ...
    iget-object v6, p1, Landroid/support/v4/app/NotificationCompat$Builder;->u:Ljava/lang/String;
    ...
    iput-object v2, p0, Landroid/support/v4/app/h;->c:Landroid/widget/RemoteViews;

    .line 124
    iget-object v2, p1, Landroid/support/v4/app/NotificationCompat$Builder;->E:Landroid/widget/RemoteViews;

    iput-object v2, p0, Landroid/support/v4/app/h;->d:Landroid/widget/RemoteViews;
    ...
    iput v2, p0, Landroid/support/v4/app/h;->g:I
    ...
    .line 152
    iget-object v3, p0, Landroid/support/v4/app/h;->a:Landroid/app/Notification$Builder;
    ...
    iput-object v0, p0, Landroid/support/v4/app/h;->h:Landroid/widget/RemoteViews;
    ...
    .line 165
    :goto_8
    iget-object v4, p1, Landroid/support/v4/app/NotificationCompat$Builder;->a:Ljava/util/ArrayList;
    ...
    .line 168
    invoke-static {v6}, Landroid/support/v4/app/i;->a(Landroid/support/v4/app/NotificationCompat$Action;)Landroid/os/Bundle;
    ...
    .line 180
    iget-object v0, p0, Landroid/support/v4/app/h;->a:Landroid/app/Notification$Builder;
    ...
    iget-object v2, p1, Landroid/support/v4/app/NotificationCompat$Builder;->F:Landroid/widget/RemoteViews;
    ...
    .line 202
    iget-object p1, p0, Landroid/support/v4/app/h;->a:Landroid/app/Notification$Builder;
...
.method private a(Landroid/support/v4/app/NotificationCompat$Action;)V
    ...
    iget-object v1, p0, Landroid/support/v4/app/h;->a:Landroid/app/Notification$Builder;

    .line 288
    invoke-static {v1, p1}, Landroid/support/v4/app/i;->a(Landroid/app/Notification$Builder;Landroid/support/v4/app/NotificationCompat$Action;)Landroid/os/Bundle;
...
.method public a()Landroid/app/Notification;
    ...
    .line 216
    iget-object v0, p0, Landroid/support/v4/app/h;->b:Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    .line 224
    :goto_0
    invoke-virtual {p0}, Landroid/support/v4/app/h;->b()Landroid/app/Notification;
    ...
    .line 227
    :cond_2
    iget-object v1, p0, Landroid/support/v4/app/h;->b:Landroid/support/v4/app/NotificationCompat$Builder;
...
.method protected b()Landroid/app/Notification;
    ...
    .line 298
    iget v1, p0, Landroid/support/v4/app/h;->g:I
    ...
    .line 303
    invoke-direct {p0, v0}, Landroid/support/v4/app/h;->a(Landroid/app/Notification;)V
    ...
    iget-object v1, p0, Landroid/support/v4/app/h;->f:Landroid/os/Bundle;
    ...
    .line 317
    iget-object v1, p0, Landroid/support/v4/app/h;->c:Landroid/widget/RemoteViews;
    ...
    .line 320
    :cond_4
    iget-object v1, p0, Landroid/support/v4/app/h;->d:Landroid/widget/RemoteViews;
    ...
    .line 323
    :cond_5
    iget-object v1, p0, Landroid/support/v4/app/h;->h:Landroid/widget/RemoteViews;
    ...
    .line 370
    invoke-static {v0}, Landroid/support/v4/app/i;->a(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    iget-object v3, p0, Landroid/support/v4/app/h;->f:Landroid/os/Bundle;
    ...
    .line 398
    invoke-static {v1}, Landroid/support/v4/app/i;->a(Ljava/util/List;)Landroid/util/SparseArray;
