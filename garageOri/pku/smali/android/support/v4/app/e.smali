...
.method constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/e;->f:Ljava/lang/String;
    ...
    iput-object v0, p0, Landroid/support/v4/app/e;->i:Landroid/os/Bundle;
    ...
    iput-object p1, p0, Landroid/support/v4/app/e;->k:Landroid/os/Bundle;
...
.method constructor <init>(Landroid/support/v4/app/Fragment;)V
    ...
    iput-boolean p1, p0, Landroid/support/v4/app/e;->j:Z
...
.method public a(Landroid/support/v4/app/FragmentHostCallback;Landroid/support/v4/app/FragmentContainer;Landroid/support/v4/app/Fragment;Landroid/support/v4/app/FragmentManagerNonConfig;Landroid/arch/lifecycle/ViewModelStore;)Landroid/support/v4/app/Fragment;
    ...
    .line 73
    iget-object v0, p0, Landroid/support/v4/app/e;->l:Landroid/support/v4/app/Fragment;
    ...
    .line 75
    iget-object v1, p0, Landroid/support/v4/app/e;->i:Landroid/os/Bundle;
    ...
    iget-object v2, p0, Landroid/support/v4/app/e;->i:Landroid/os/Bundle;
    ...
    iput-object p2, p0, Landroid/support/v4/app/e;->l:Landroid/support/v4/app/Fragment;

    goto :goto_0

    .line 82
    :cond_1
    iget-object p2, p0, Landroid/support/v4/app/e;->a:Ljava/lang/String;
    ...
    .line 85
    :goto_0
    iget-object p2, p0, Landroid/support/v4/app/e;->k:Landroid/os/Bundle;
    ...
    .line 87
    iget-object p2, p0, Landroid/support/v4/app/e;->l:Landroid/support/v4/app/Fragment;

    iget-object v0, p0, Landroid/support/v4/app/e;->k:Landroid/os/Bundle;
    ...
    iget-boolean p3, p0, Landroid/support/v4/app/e;->c:Z
    ...
    iget p3, p0, Landroid/support/v4/app/e;->d:I
    ...
    iget p3, p0, Landroid/support/v4/app/e;->e:I
    ...
    iget-object p3, p0, Landroid/support/v4/app/e;->f:Ljava/lang/String;
    ...
    iget-boolean p3, p0, Landroid/support/v4/app/e;->g:Z
    ...
    iget-boolean p3, p0, Landroid/support/v4/app/e;->h:Z
    ...
    iget-boolean p3, p0, Landroid/support/v4/app/e;->j:Z
    ...
    iput-object p1, p2, Landroid/support/v4/app/Fragment;->mFragmentManager:Landroid/support/v4/app/c;

    .line 100
    sget-boolean p1, Landroid/support/v4/app/c;->a:Z
    ...
    iget-object p3, p0, Landroid/support/v4/app/e;->l:Landroid/support/v4/app/Fragment;
    ...
    .line 104
    :cond_3
    iget-object p1, p0, Landroid/support/v4/app/e;->l:Landroid/support/v4/app/Fragment;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 118
    iget-boolean p2, p0, Landroid/support/v4/app/e;->c:Z
    ...
    .line 121
    iget-object p2, p0, Landroid/support/v4/app/e;->f:Ljava/lang/String;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    .line 122
    iget-boolean p2, p0, Landroid/support/v4/app/e;->g:Z

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 123
    iget-boolean p2, p0, Landroid/support/v4/app/e;->h:Z

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    .line 124
    iget-object p2, p0, Landroid/support/v4/app/e;->i:Landroid/os/Bundle;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeBundle(Landroid/os/Bundle;)V

    .line 125
    iget-boolean p2, p0, Landroid/support/v4/app/e;->j:Z
