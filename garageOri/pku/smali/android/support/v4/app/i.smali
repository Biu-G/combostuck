...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/app/i;->a:Ljava/lang/Object;
    ...
    sput-object v0, Landroid/support/v4/app/i;->d:Ljava/lang/Object;
...
.method public static a(Landroid/app/Notification$Builder;Landroid/support/v4/app/NotificationCompat$Action;)Landroid/os/Bundle;
    ...
    invoke-static {v1}, Landroid/support/v4/app/i;->a([Landroid/support/v4/app/RemoteInput;)[Landroid/os/Bundle;
...
.method public static a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    .line 90
    sget-object v0, Landroid/support/v4/app/i;->a:Ljava/lang/Object;

    monitor-enter v0

    .line 91
    :try_start_0
    sget-boolean v1, Landroid/support/v4/app/i;->c:Z
    ...
    .line 95
    :try_start_1
    sget-object v3, Landroid/support/v4/app/i;->b:Ljava/lang/reflect/Field;
    ...
    .line 99
    sput-boolean v1, Landroid/support/v4/app/i;->c:Z
    :try_end_1
    ...
    .line 103
    sput-object v3, Landroid/support/v4/app/i;->b:Ljava/lang/reflect/Field;
    ...
    .line 108
    sget-object v4, Landroid/support/v4/app/i;->b:Ljava/lang/reflect/Field;
...
.method static a(Landroid/support/v4/app/NotificationCompat$Action;)Landroid/os/Bundle;
    ...
    invoke-static {v2}, Landroid/support/v4/app/i;->a([Landroid/support/v4/app/RemoteInput;)[Landroid/os/Bundle;
...
.method public static a(ILjava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;)Landroid/support/v4/app/NotificationCompat$Action;
    ...
    .line 128
    invoke-static {p3, v0}, Landroid/support/v4/app/i;->a(Landroid/os/Bundle;Ljava/lang/String;)[Landroid/os/Bundle;

    move-result-object v0

    .line 127
    invoke-static {v0}, Landroid/support/v4/app/i;->a([Landroid/os/Bundle;)[Landroid/support/v4/app/RemoteInput;
    ...
    .line 131
    invoke-static {p3, v1}, Landroid/support/v4/app/i;->a(Landroid/os/Bundle;Ljava/lang/String;)[Landroid/os/Bundle;

    move-result-object v1

    .line 130
    invoke-static {v1}, Landroid/support/v4/app/i;->a([Landroid/os/Bundle;)[Landroid/support/v4/app/RemoteInput;
...
.method public static a(Landroid/app/Notification;I)Landroid/support/v4/app/NotificationCompat$Action;
    ...
    .line 164
    sget-object v0, Landroid/support/v4/app/i;->d:Ljava/lang/Object;
    ...
    .line 166
    :try_start_0
    invoke-static {p0}, Landroid/support/v4/app/i;->c(Landroid/app/Notification;)[Ljava/lang/Object;
    ...
    .line 170
    invoke-static {p0}, Landroid/support/v4/app/i;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    .line 178
    :goto_0
    sget-object p1, Landroid/support/v4/app/i;->g:Ljava/lang/reflect/Field;

    invoke-virtual {p1, v2}, Ljava/lang/reflect/Field;->getInt(Ljava/lang/Object;)I

    move-result p1

    sget-object v3, Landroid/support/v4/app/i;->h:Ljava/lang/reflect/Field;
    ...
    sget-object v4, Landroid/support/v4/app/i;->i:Ljava/lang/reflect/Field;
    ...
    .line 178
    invoke-static {p1, v3, v2, p0}, Landroid/support/v4/app/i;->a(ILjava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;)Landroid/support/v4/app/NotificationCompat$Action;
    ...
    .line 185
    sput-boolean p0, Landroid/support/v4/app/i;->j:Z
...
.method static a(Landroid/os/Bundle;)Landroid/support/v4/app/NotificationCompat$Action;
    ...
    .line 241
    invoke-static {p0, v1}, Landroid/support/v4/app/i;->a(Landroid/os/Bundle;Ljava/lang/String;)[Landroid/os/Bundle;
...
.method private static a()Z
    ...
    .line 208
    sget-boolean v0, Landroid/support/v4/app/i;->j:Z
    ...
    .line 212
    :try_start_0
    sget-object v1, Landroid/support/v4/app/i;->f:Ljava/lang/reflect/Field;
    ...
    sput-object v1, Landroid/support/v4/app/i;->e:Ljava/lang/Class;

    .line 214
    sget-object v1, Landroid/support/v4/app/i;->e:Ljava/lang/Class;
    ...
    sput-object v1, Landroid/support/v4/app/i;->g:Ljava/lang/reflect/Field;
    ...
    sput-object v1, Landroid/support/v4/app/i;->h:Ljava/lang/reflect/Field;
    ...
    sput-object v1, Landroid/support/v4/app/i;->i:Ljava/lang/reflect/Field;
    ...
    sput-object v1, Landroid/support/v4/app/i;->f:Ljava/lang/reflect/Field;
    ...
    .line 225
    sput-boolean v0, Landroid/support/v4/app/i;->j:Z
    ...
    :cond_1
    :goto_0
    sget-boolean v1, Landroid/support/v4/app/i;->j:Z
...
.method private static a([Landroid/os/Bundle;)[Landroid/support/v4/app/RemoteInput;
    ...
    invoke-static {v2}, Landroid/support/v4/app/i;->b(Landroid/os/Bundle;)Landroid/support/v4/app/RemoteInput;
...
.method private static c(Landroid/app/Notification;)[Ljava/lang/Object;
    ...
    .line 193
    :try_start_0
    invoke-static {}, Landroid/support/v4/app/i;->a()Z
