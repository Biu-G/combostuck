.class Landroid/support/v4/provider/d;
...
.method constructor <init>(Landroid/support/v4/provider/DocumentFile;Landroid/content/Context;Landroid/net/Uri;)V
    ...
    .line 38
    iput-object p2, p0, Landroid/support/v4/provider/d;->a:Landroid/content/Context;

    .line 39
    iput-object p3, p0, Landroid/support/v4/provider/d;->b:Landroid/net/Uri;
...
.method public canRead()Z
    ...
    .line 112
    iget-object v0, p0, Landroid/support/v4/provider/d;->a:Landroid/content/Context;

    iget-object v1, p0, Landroid/support/v4/provider/d;->b:Landroid/net/Uri;
...
.method public createDirectory(Ljava/lang/String;)Landroid/support/v4/provider/DocumentFile;
    ...
    invoke-static {v0, v1, v2, p1}, Landroid/support/v4/provider/d;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    ...
    .line 65
    new-instance v0, Landroid/support/v4/provider/d;

    iget-object v1, p0, Landroid/support/v4/provider/d;->a:Landroid/content/Context;

    invoke-direct {v0, p0, v1, p1}, Landroid/support/v4/provider/d;-><init>(Landroid/support/v4/provider/DocumentFile;Landroid/content/Context;Landroid/net/Uri;)V
...
.method public createFile(Ljava/lang/String;Ljava/lang/String;)Landroid/support/v4/provider/DocumentFile;
    ...
    invoke-static {v0, v1, p1, p2}, Landroid/support/v4/provider/d;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-direct {p2, p0, v0, p1}, Landroid/support/v4/provider/d;-><init>(Landroid/support/v4/provider/DocumentFile;Landroid/content/Context;Landroid/net/Uri;)V
...
.method public getUri()Landroid/net/Uri;
    ...
    .line 70
    iget-object v0, p0, Landroid/support/v4/provider/d;->b:Landroid/net/Uri;
...
.method public listFiles()[Landroid/support/v4/provider/DocumentFile;
    ...
    iget-object v2, p0, Landroid/support/v4/provider/d;->b:Landroid/net/Uri;
    ...
    .line 147
    iget-object v3, p0, Landroid/support/v4/provider/d;->b:Landroid/net/Uri;
    ...
    .line 154
    :cond_0
    invoke-static {v1}, Landroid/support/v4/provider/d;->a(Ljava/lang/AutoCloseable;)V
    ...
    .line 154
    invoke-static {v8}, Landroid/support/v4/provider/d;->a(Ljava/lang/AutoCloseable;)V
    ...
    .line 160
    new-instance v2, Landroid/support/v4/provider/d;

    iget-object v3, p0, Landroid/support/v4/provider/d;->a:Landroid/content/Context;

    aget-object v4, v0, v7

    invoke-direct {v2, p0, v3, v4}, Landroid/support/v4/provider/d;-><init>(Landroid/support/v4/provider/DocumentFile;Landroid/content/Context;Landroid/net/Uri;)V
...
.method public renameTo(Ljava/lang/String;)Z
    ...
    .line 182
    iput-object p1, p0, Landroid/support/v4/provider/d;->b:Landroid/net/Uri;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
