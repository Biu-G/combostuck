...
.method a(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    .line 3270
    sget-boolean v0, Landroid/support/v4/media/session/MediaSessionCompat$b;->x:Z

    if-eqz v0, :cond_0

    .line 3272
    :try_start_0
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$b;->c:Landroid/media/AudioManager;
    ...
    .line 3276
    sput-boolean v0, Landroid/support/v4/media/session/MediaSessionCompat$b;->x:Z
...
.method public a(Landroid/support/v4/media/session/MediaSessionCompat$Callback;Landroid/os/Handler;)V
    ...
    .line 3223
    iget-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$b;->d:Landroid/media/RemoteControlClient;
    ...
    .line 3225
    :cond_0
    new-instance p1, Landroid/support/v4/media/session/MediaSessionCompat$b$1;

    invoke-direct {p1, p0}, Landroid/support/v4/media/session/MediaSessionCompat$b$1;-><init>(Landroid/support/v4/media/session/MediaSessionCompat$b;)V

    .line 3233
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$b;->d:Landroid/media/RemoteControlClient;
...
.method b(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    .line 3289
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$b;->c:Landroid/media/AudioManager;
...
.method b(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    .line 3253
    :cond_1
    iget-object v3, p0, Landroid/support/v4/media/session/MediaSessionCompat$b;->d:Landroid/media/RemoteControlClient;

    invoke-virtual {p1}, Landroid/support/v4/media/session/PlaybackStateCompat;->getState()I

    move-result p1

    invoke-virtual {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$b;->f(I)I
