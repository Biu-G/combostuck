...
.field private static volatile d:Landroid/support/v4/media/MediaSessionManager;


# instance fields
.field b:Landroid/support/v4/media/MediaSessionManager$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/media/MediaSessionManager;->c:Ljava/lang/Object;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/v4/media/j;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v4/media/MediaSessionManager;->b:Landroid/support/v4/media/MediaSessionManager$a;
    ...
    invoke-direct {v0, p1}, Landroid/support/v4/media/i;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/v4/media/k;-><init>(Landroid/content/Context;)V
...
.method public static getSessionManager(Landroid/content/Context;)Landroid/support/v4/media/MediaSessionManager;
    ...
    .line 55
    sget-object v0, Landroid/support/v4/media/MediaSessionManager;->d:Landroid/support/v4/media/MediaSessionManager;

    if-nez v0, :cond_1

    .line 57
    sget-object v1, Landroid/support/v4/media/MediaSessionManager;->c:Ljava/lang/Object;
    ...
    sput-object v0, Landroid/support/v4/media/MediaSessionManager;->d:Landroid/support/v4/media/MediaSessionManager;

    .line 61
    sget-object p0, Landroid/support/v4/media/MediaSessionManager;->d:Landroid/support/v4/media/MediaSessionManager;
...
.method public isTrustedForMediaControl(Landroid/support/v4/media/MediaSessionManager$RemoteUserInfo;)Z
    ...
    .line 94
    iget-object v0, p0, Landroid/support/v4/media/MediaSessionManager;->b:Landroid/support/v4/media/MediaSessionManager$a;
