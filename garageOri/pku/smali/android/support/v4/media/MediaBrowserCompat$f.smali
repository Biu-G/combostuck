...
.method private a(Landroid/os/Messenger;Ljava/lang/String;)Z
    ...
    iget p1, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->f:I
    ...
    iget-object p2, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->i:Landroid/os/Messenger;
...
.method a()V
    ...
    .line 1129
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->g:Landroid/support/v4/media/MediaBrowserCompat$f$a;

    .line 1130
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->h:Landroid/support/v4/media/MediaBrowserCompat$h;

    .line 1131
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->i:Landroid/os/Messenger;
...
.method public a(Landroid/os/Messenger;Ljava/lang/String;Landroid/support/v4/media/session/MediaSessionCompat$Token;Landroid/os/Bundle;)V
    ...
    iget p3, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->f:I
    ...
    .line 1341
    iput p1, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->f:I
    ...
    .line 1353
    :try_start_0
    iget-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->j:Landroid/support/v4/util/ArrayMap;
    ...
    .line 1356
    invoke-virtual {p2}, Landroid/support/v4/media/MediaBrowserCompat$i;->c()Ljava/util/List;
    ...
    iget-object v2, v2, Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;->b:Landroid/os/IBinder;
    ...
    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->i:Landroid/os/Messenger;

    .line 1359
    invoke-virtual {v1, p3, v2, v3, v4}, Landroid/support/v4/media/MediaBrowserCompat$h;->a(Ljava/lang/String;Landroid/os/IBinder;Landroid/os/Bundle;Landroid/os/Messenger;)V
    :try_end_0
...
.method public a(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$CustomActionCallback;)V
    ...
    invoke-direct {v1, p0, p3, p1, p2}, Landroid/support/v4/media/MediaBrowserCompat$f$6;-><init>(Landroid/support/v4/media/MediaBrowserCompat$f;Landroid/support/v4/media/MediaBrowserCompat$CustomActionCallback;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public a(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$SearchCallback;)V
    ...
    invoke-direct {v1, p0, p3, p1, p2}, Landroid/support/v4/media/MediaBrowserCompat$f$5;-><init>(Landroid/support/v4/media/MediaBrowserCompat$f;Landroid/support/v4/media/MediaBrowserCompat$SearchCallback;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public a(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserCompat$ItemCallback;)V
    ...
    invoke-direct {v1, p0, p2, p1}, Landroid/support/v4/media/MediaBrowserCompat$f$4;-><init>(Landroid/support/v4/media/MediaBrowserCompat$f;Landroid/support/v4/media/MediaBrowserCompat$ItemCallback;Ljava/lang/String;)V
...
.method public a(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;)V
    ...
    .line 1239
    :cond_5
    iget-object p2, p0, Landroid/support/v4/media/MediaBrowserCompat$f;->j:Landroid/support/v4/util/ArrayMap;
...
.method public d()V
    ...
    invoke-direct {v1, p0}, Landroid/support/v4/media/MediaBrowserCompat$f$1;-><init>(Landroid/support/v4/media/MediaBrowserCompat$f;)V
...
.method public e()V
    ...
    invoke-direct {v1, p0}, Landroid/support/v4/media/MediaBrowserCompat$f$2;-><init>(Landroid/support/v4/media/MediaBrowserCompat$f;)V
