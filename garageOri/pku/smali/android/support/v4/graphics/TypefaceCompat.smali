...
# static fields
.field private static final a:Landroid/support/v4/graphics/c;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/graphics/TypefaceCompat;->a:Landroid/support/v4/graphics/c;
    ...
    invoke-direct {v0}, Landroid/support/v4/graphics/c;-><init>()V
...
.method public static createFromFontInfo(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/provider/FontsContractCompat$FontInfo;I)Landroid/graphics/Typeface;
    ...
    .line 155
    sget-object v0, Landroid/support/v4/graphics/TypefaceCompat;->a:Landroid/support/v4/graphics/c;

    invoke-virtual {v0, p0, p1, p2, p3}, Landroid/support/v4/graphics/c;->createFromFontInfo(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/provider/FontsContractCompat$FontInfo;I)Landroid/graphics/Typeface;
...
.method public static createFromResourcesFamilyXml(Landroid/content/Context;Landroid/support/v4/content/res/FontResourcesParserCompat$FamilyResourceEntry;Landroid/content/res/Resources;IILandroid/support/v4/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    ...
    .line 115
    :cond_3
    sget-object v1, Landroid/support/v4/graphics/TypefaceCompat;->a:Landroid/support/v4/graphics/c;

    move-object v0, p1

    check-cast v0, Landroid/support/v4/content/res/FontResourcesParserCompat$FontFamilyFilesResourceEntry;

    invoke-virtual {v1, p0, v0, p2, p4}, Landroid/support/v4/graphics/c;->createFromFontFamilyFilesResourceEntry(Landroid/content/Context;Landroid/support/v4/content/res/FontResourcesParserCompat$FontFamilyFilesResourceEntry;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
...
.method public static createFromResourcesFontFile(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v4/graphics/c;->createFromResourcesFontFile(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
