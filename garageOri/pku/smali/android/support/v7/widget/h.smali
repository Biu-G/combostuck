...
.method constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 48
    iput-object p1, p0, Landroid/support/v7/widget/h;->b:Landroid/widget/ProgressBar;
...
.method private a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v4, v5}, Landroid/support/v7/widget/h;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method private a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 76
    invoke-direct {p0, v1, p2}, Landroid/support/v7/widget/h;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :goto_2
    invoke-direct {p0, v5, v4}, Landroid/support/v7/widget/h;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 100
    iget-object v2, p0, Landroid/support/v7/widget/h;->c:Landroid/graphics/Bitmap;

    if-nez v2, :cond_6

    .line 101
    iput-object v0, p0, Landroid/support/v7/widget/h;->c:Landroid/graphics/Bitmap;

    .line 104
    :cond_6
    new-instance v2, Landroid/graphics/drawable/ShapeDrawable;

    invoke-direct {p0}, Landroid/support/v7/widget/h;->b()Landroid/graphics/drawable/shapes/Shape;
...
.method a()Landroid/graphics/Bitmap;
    ...
    .line 145
    iget-object v0, p0, Landroid/support/v7/widget/h;->c:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 52
    iget-object v0, p0, Landroid/support/v7/widget/h;->b:Landroid/widget/ProgressBar;
    ...
    invoke-direct {p0, p2}, Landroid/support/v7/widget/h;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p2, v2}, Landroid/support/v7/widget/h;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
