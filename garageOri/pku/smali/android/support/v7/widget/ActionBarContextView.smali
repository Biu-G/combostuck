...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput p2, p0, Landroid/support/v7/widget/ActionBarContextView;->h:I
    ...
    iput p2, p0, Landroid/support/v7/widget/ActionBarContextView;->i:I
...
.method private a()V
    ...
    .line 134
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->e:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->e:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->f:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->g:Landroid/widget/TextView;

    .line 140
    iget v0, p0, Landroid/support/v7/widget/ActionBarContextView;->h:I

    if-eqz v0, :cond_0

    .line 141
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->f:Landroid/widget/TextView;

    invoke-virtual {p0}, Landroid/support/v7/widget/ActionBarContextView;->getContext()Landroid/content/Context;

    move-result-object v1

    iget v2, p0, Landroid/support/v7/widget/ActionBarContextView;->h:I

    invoke-virtual {v0, v1, v2}, Landroid/widget/TextView;->setTextAppearance(Landroid/content/Context;I)V

    .line 143
    :cond_0
    iget v0, p0, Landroid/support/v7/widget/ActionBarContextView;->i:I

    if-eqz v0, :cond_1

    .line 144
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->g:Landroid/widget/TextView;

    invoke-virtual {p0}, Landroid/support/v7/widget/ActionBarContextView;->getContext()Landroid/content/Context;

    move-result-object v1

    iget v2, p0, Landroid/support/v7/widget/ActionBarContextView;->i:I
    ...
    .line 153
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarContextView;->g:Landroid/widget/TextView;
    ...
    .line 154
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarContextView;->e:Landroid/widget/LinearLayout;
...
.method public closeMode()V
    ...
    .line 193
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Landroid/view/View;
...
.method public hideOverflowMenu()Z
    ...
    .line 215
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->mActionMenuPresenter:Landroid/support/v7/widget/b;
...
.method public initForMode(Landroid/support/v7/view/ActionMode;)V
    ...
    .line 163
    iget v1, p0, Landroid/support/v7/widget/ActionBarContextView;->k:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Landroid/view/View;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/b;->d()Z
    ...
    invoke-direct {v0, v1}, Landroid/support/v7/widget/b;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->mActionMenuPresenter:Landroid/support/v7/widget/b;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/b;->a(Z)V
    ...
    .line 186
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->mActionMenuPresenter:Landroid/support/v7/widget/b;
    ...
    .line 187
    iget-object p1, p0, Landroid/support/v7/widget/ActionBarContextView;->mActionMenuPresenter:Landroid/support/v7/widget/b;

    invoke-virtual {p1, p0}, Landroid/support/v7/widget/b;->getMenuView(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/MenuView;
...
.method public killMode()V
    ...
    .line 201
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Landroid/view/View;
...
.method public onDetachedFromWindow()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/b;->e()Z
...
.method protected onLayout(ZIIII)V
    ...
    .line 328
    iget-object p5, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Landroid/view/View;
    ...
    .line 333
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Landroid/view/View;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Landroid/view/View;
    ...
    .line 338
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->e:Landroid/widget/LinearLayout;
    ...
    .line 341
    iget-object p5, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Landroid/view/View;

    if-eqz p5, :cond_5

    .line 342
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Landroid/view/View;
...
.method protected onMeasure(II)V
    ...
    .line 265
    iget-object v6, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Landroid/view/View;
    ...
    .line 276
    :cond_2
    iget-object v6, p0, Landroid/support/v7/widget/ActionBarContextView;->e:Landroid/widget/LinearLayout;

    if-eqz v6, :cond_7

    iget-object v6, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Landroid/view/View;

    if-nez v6, :cond_7

    .line 277
    iget-boolean v6, p0, Landroid/support/v7/widget/ActionBarContextView;->j:Z
    ...
    .line 279
    iget-object v8, p0, Landroid/support/v7/widget/ActionBarContextView;->e:Landroid/widget/LinearLayout;

    invoke-virtual {v8, v6, v5}, Landroid/widget/LinearLayout;->measure(II)V

    .line 280
    iget-object v5, p0, Landroid/support/v7/widget/ActionBarContextView;->e:Landroid/widget/LinearLayout;
    ...
    :cond_7
    :goto_3
    iget-object v5, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Landroid/view/View;
    ...
    .line 301
    :cond_b
    iget-object v4, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Landroid/view/View;
...
.method public setCustomView(Landroid/view/View;)V
    ...
    .line 104
    :cond_0
    iput-object p1, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Landroid/view/View;
