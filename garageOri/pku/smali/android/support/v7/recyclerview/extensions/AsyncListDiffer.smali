...
# instance fields
.field final a:Landroid/support/v7/recyclerview/extensions/AsyncDifferConfig;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private final d:Landroid/support/v7/util/ListUpdateCallback;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/recyclerview/extensions/AsyncListDiffer;->e:Ljava/util/concurrent/Executor;
...
.method public constructor <init>(Landroid/support/v7/util/ListUpdateCallback;Landroid/support/v7/recyclerview/extensions/AsyncDifferConfig;)V
    ...
    iput-object v0, p0, Landroid/support/v7/recyclerview/extensions/AsyncListDiffer;->g:Ljava/util/List;

    .line 162
    iput-object p1, p0, Landroid/support/v7/recyclerview/extensions/AsyncListDiffer;->d:Landroid/support/v7/util/ListUpdateCallback;

    .line 163
    iput-object p2, p0, Landroid/support/v7/recyclerview/extensions/AsyncListDiffer;->a:Landroid/support/v7/recyclerview/extensions/AsyncDifferConfig;
    ...
    iput-object p1, p0, Landroid/support/v7/recyclerview/extensions/AsyncListDiffer;->b:Ljava/util/concurrent/Executor;

    goto :goto_0

    .line 167
    :cond_0
    sget-object p1, Landroid/support/v7/recyclerview/extensions/AsyncListDiffer;->e:Ljava/util/concurrent/Executor;
...
.method a(Ljava/util/List;Landroid/support/v7/util/DiffUtil$DiffResult;)V
    ...
    iput-object p1, p0, Landroid/support/v7/recyclerview/extensions/AsyncListDiffer;->g:Ljava/util/List;

    .line 318
    iget-object p1, p0, Landroid/support/v7/recyclerview/extensions/AsyncListDiffer;->d:Landroid/support/v7/util/ListUpdateCallback;
...
.method public getCurrentList()Ljava/util/List;
    ...
    .line 199
    iget-object v0, p0, Landroid/support/v7/recyclerview/extensions/AsyncListDiffer;->g:Ljava/util/List;
...
.method public submitList(Ljava/util/List;)V
    ...
    .line 215
    iget v0, p0, Landroid/support/v7/recyclerview/extensions/AsyncListDiffer;->c:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, Landroid/support/v7/recyclerview/extensions/AsyncListDiffer;->c:I

    .line 217
    iget-object v1, p0, Landroid/support/v7/recyclerview/extensions/AsyncListDiffer;->f:Ljava/util/List;
    ...
    .line 225
    iget-object p1, p0, Landroid/support/v7/recyclerview/extensions/AsyncListDiffer;->f:Ljava/util/List;
    ...
    .line 229
    iget-object v0, p0, Landroid/support/v7/recyclerview/extensions/AsyncListDiffer;->d:Landroid/support/v7/util/ListUpdateCallback;
    ...
    .line 234
    :cond_1
    iget-object v2, p0, Landroid/support/v7/recyclerview/extensions/AsyncListDiffer;->f:Ljava/util/List;
    ...
    .line 243
    iget-object v2, p0, Landroid/support/v7/recyclerview/extensions/AsyncListDiffer;->a:Landroid/support/v7/recyclerview/extensions/AsyncDifferConfig;
