...
.method declared-synchronized a()Landroid/support/v7/util/a$b;
    ...
    iget-object v1, v1, Landroid/support/v7/util/a$b;->a:Landroid/support/v7/util/a$b;
...
.method declared-synchronized a(I)V
    ...
    .line 269
    iget-object v1, v0, Landroid/support/v7/util/a$b;->a:Landroid/support/v7/util/a$b;

    :goto_1
    if-eqz v1, :cond_2

    .line 271
    iget-object v2, v1, Landroid/support/v7/util/a$b;->a:Landroid/support/v7/util/a$b;

    .line 272
    iget v3, v1, Landroid/support/v7/util/a$b;->b:I

    if-ne v3, p1, :cond_1

    .line 273
    iput-object v2, v0, Landroid/support/v7/util/a$b;->a:Landroid/support/v7/util/a$b;
...
.method declared-synchronized a(Landroid/support/v7/util/a$b;)V
    ...
    iput-object v0, p1, Landroid/support/v7/util/a$b;->a:Landroid/support/v7/util/a$b;
...
.method declared-synchronized b(Landroid/support/v7/util/a$b;)V
    ...
    .line 256
    iget-object v0, v0, Landroid/support/v7/util/a$b;->a:Landroid/support/v7/util/a$b;

    goto :goto_0

    .line 258
    :cond_1
    iput-object p1, v0, Landroid/support/v7/util/a$b;->a:Landroid/support/v7/util/a$b;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
