...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/preference/MultiSelectListPreferenceDialogFragmentCompat;->j:Ljava/util/Set;

    return-void
.end method

.method private a()Landroid/support/v7/preference/internal/AbstractMultiSelectListPreference;
    .locals 1
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 64
    invoke-direct {p0}, Landroid/support/v7/preference/MultiSelectListPreferenceDialogFragmentCompat;->a()Landroid/support/v7/preference/internal/AbstractMultiSelectListPreference;
    ...
    .line 72
    iget-object v1, p0, Landroid/support/v7/preference/MultiSelectListPreferenceDialogFragmentCompat;->j:Ljava/util/Set;
    ...
    .line 74
    iput-boolean v0, p0, Landroid/support/v7/preference/MultiSelectListPreferenceDialogFragmentCompat;->k:Z
    ...
    iput-object v0, p0, Landroid/support/v7/preference/MultiSelectListPreferenceDialogFragmentCompat;->l:[Ljava/lang/CharSequence;
    ...
    iput-object p1, p0, Landroid/support/v7/preference/MultiSelectListPreferenceDialogFragmentCompat;->m:[Ljava/lang/CharSequence;
...
.method public onDialogClosed(Z)V
    ...
    .line 126
    iget-boolean p1, p0, Landroid/support/v7/preference/MultiSelectListPreferenceDialogFragmentCompat;->k:Z

    if-eqz p1, :cond_0

    .line 127
    iget-object p1, p0, Landroid/support/v7/preference/MultiSelectListPreferenceDialogFragmentCompat;->j:Ljava/util/Set;
    ...
    .line 132
    iput-boolean p1, p0, Landroid/support/v7/preference/MultiSelectListPreferenceDialogFragmentCompat;->k:Z
...
.method protected onPrepareDialogBuilder(Landroid/support/v7/app/AlertDialog$Builder;)V
    ...
    .line 103
    iget-object v0, p0, Landroid/support/v7/preference/MultiSelectListPreferenceDialogFragmentCompat;->m:[Ljava/lang/CharSequence;
    ...
    .line 106
    iget-object v3, p0, Landroid/support/v7/preference/MultiSelectListPreferenceDialogFragmentCompat;->j:Ljava/util/Set;

    iget-object v4, p0, Landroid/support/v7/preference/MultiSelectListPreferenceDialogFragmentCompat;->m:[Ljava/lang/CharSequence;
    ...
    .line 108
    :cond_0
    iget-object v0, p0, Landroid/support/v7/preference/MultiSelectListPreferenceDialogFragmentCompat;->l:[Ljava/lang/CharSequence;
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Landroid/support/v7/preference/MultiSelectListPreferenceDialogFragmentCompat;->j:Ljava/util/Set;
    ...
    .line 90
    iget-boolean v1, p0, Landroid/support/v7/preference/MultiSelectListPreferenceDialogFragmentCompat;->k:Z
    ...
    .line 91
    iget-object v1, p0, Landroid/support/v7/preference/MultiSelectListPreferenceDialogFragmentCompat;->l:[Ljava/lang/CharSequence;
    ...
    .line 92
    iget-object v1, p0, Landroid/support/v7/preference/MultiSelectListPreferenceDialogFragmentCompat;->m:[Ljava/lang/CharSequence;
