...
.method constructor <init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/ShadowViewDelegate;)V
    ...
    .line 53
    invoke-direct {p0, p1, p2}, Landroid/support/design/widget/b;-><init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/ShadowViewDelegate;)V
...
.method private a(FF)Landroid/animation/Animator;
    ...
    .line 156
    iget-object v1, p0, Landroid/support/design/widget/c;->v:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    .line 160
    sget-object p1, Landroid/support/design/widget/c;->a:Landroid/animation/TimeInterpolator;
...
.method public a()F
    ...
    .line 166
    iget-object v0, p0, Landroid/support/design/widget/c;->v:Landroid/support/design/widget/VisibilityAwareImageButton;
...
.method a(FFF)V
    ...
    .line 105
    iget-object p1, p0, Landroid/support/design/widget/c;->v:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    .line 110
    sget-object v1, Landroid/support/design/widget/c;->p:[I

    .line 111
    invoke-direct {p0, p1, p3}, Landroid/support/design/widget/c;->a(FF)Landroid/animation/Animator;
    ...
    .line 112
    sget-object p3, Landroid/support/design/widget/c;->q:[I

    .line 114
    invoke-direct {p0, p1, p2}, Landroid/support/design/widget/c;->a(FF)Landroid/animation/Animator;
    ...
    .line 115
    sget-object p3, Landroid/support/design/widget/c;->r:[I
    ...
    .line 118
    sget-object p3, Landroid/support/design/widget/c;->s:[I
    ...
    iget-object v4, p0, Landroid/support/design/widget/c;->v:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    .line 140
    sget-object p1, Landroid/support/design/widget/c;->t:[I

    invoke-virtual {v0, p1, p2}, Landroid/animation/StateListAnimator;->addState([ILandroid/animation/Animator;)V

    .line 143
    sget-object p1, Landroid/support/design/widget/c;->u:[I

    invoke-direct {p0, v3, v3}, Landroid/support/design/widget/c;->a(FF)Landroid/animation/Animator;
    ...
    .line 148
    :goto_0
    iget-object p1, p0, Landroid/support/design/widget/c;->w:Landroid/support/design/widget/ShadowViewDelegate;
...
.method a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Landroid/content/res/ColorStateList;I)V
    ...
    .line 63
    invoke-virtual {p0}, Landroid/support/design/widget/c;->p()Landroid/graphics/drawable/GradientDrawable;
    ...
    iput-object v0, p0, Landroid/support/design/widget/c;->g:Landroid/graphics/drawable/Drawable;
    ...
    .line 71
    invoke-virtual {p0, p4, p1}, Landroid/support/design/widget/c;->a(ILandroid/content/res/ColorStateList;)Landroid/support/design/widget/CircularBorderDrawable;

    move-result-object p1

    iput-object p1, p0, Landroid/support/design/widget/c;->i:Landroid/support/design/widget/CircularBorderDrawable;
    ...
    iget-object v1, p0, Landroid/support/design/widget/c;->i:Landroid/support/design/widget/CircularBorderDrawable;

    aput-object v1, p4, v0

    const/4 v0, 0x1

    iget-object v1, p0, Landroid/support/design/widget/c;->g:Landroid/graphics/drawable/Drawable;
    ...
    .line 74
    :cond_1
    iput-object p2, p0, Landroid/support/design/widget/c;->i:Landroid/support/design/widget/CircularBorderDrawable;

    .line 75
    iget-object p1, p0, Landroid/support/design/widget/c;->g:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p4, p0, Landroid/support/design/widget/c;->h:Landroid/graphics/drawable/Drawable;

    .line 82
    iget-object p1, p0, Landroid/support/design/widget/c;->h:Landroid/graphics/drawable/Drawable;

    iput-object p1, p0, Landroid/support/design/widget/c;->j:Landroid/graphics/drawable/Drawable;

    .line 84
    iget-object p1, p0, Landroid/support/design/widget/c;->w:Landroid/support/design/widget/ShadowViewDelegate;

    iget-object p2, p0, Landroid/support/design/widget/c;->h:Landroid/graphics/drawable/Drawable;
...
.method a(Landroid/graphics/Rect;)V
    ...
    .line 228
    iget-object v0, p0, Landroid/support/design/widget/c;->w:Landroid/support/design/widget/ShadowViewDelegate;
    ...
    iget v3, p0, Landroid/support/design/widget/c;->m:F
...
.method a([I)V
    ...
    iget v1, p0, Landroid/support/design/widget/c;->k:F
...
.method b(Landroid/content/res/ColorStateList;)V
    ...
    .line 93
    :cond_0
    invoke-super {p0, p1}, Landroid/support/design/widget/b;->b(Landroid/content/res/ColorStateList;)V
...
.method b(Landroid/graphics/Rect;)V
    ...
    iget-object v2, p0, Landroid/support/design/widget/c;->h:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Landroid/support/design/widget/c;->x:Landroid/graphics/drawable/InsetDrawable;

    .line 180
    iget-object p1, p0, Landroid/support/design/widget/c;->w:Landroid/support/design/widget/ShadowViewDelegate;

    iget-object v0, p0, Landroid/support/design/widget/c;->x:Landroid/graphics/drawable/InsetDrawable;
...
.method q()Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-direct {v0}, Landroid/support/design/widget/c$a;-><init>()V
