...
.field private final o:Landroid/support/design/expandable/ExpandableWidgetHelper;

.field private p:Landroid/support/design/widget/b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p2, p0, Landroid/support/design/widget/FloatingActionButton;->o:Landroid/support/design/expandable/ExpandableWidgetHelper;

    .line 234
    invoke-direct {p0}, Landroid/support/design/widget/FloatingActionButton;->getImpl()Landroid/support/design/widget/b;
    ...
    invoke-virtual {p2, p3, v1, v5, v6}, Landroid/support/design/widget/b;->a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Landroid/content/res/ColorStateList;I)V
    ...
    invoke-virtual {p2, v2}, Landroid/support/design/widget/b;->a(F)V
    ...
    invoke-virtual {p2, v4}, Landroid/support/design/widget/b;->b(F)V
    ...
    invoke-virtual {p2, v3}, Landroid/support/design/widget/b;->c(F)V
    ...
    invoke-virtual {p2, p3}, Landroid/support/design/widget/b;->a(I)V
    ...
    invoke-virtual {p2, v0}, Landroid/support/design/widget/b;->a(Landroid/support/design/animation/MotionSpec;)V
    ...
    invoke-virtual {p2, p1}, Landroid/support/design/widget/b;->b(Landroid/support/design/animation/MotionSpec;)V
...
.method private a(I)I
    ...
    .line 703
    iget p1, p0, Landroid/support/design/widget/FloatingActionButton;->j:I
...
.method private a(Landroid/support/design/widget/FloatingActionButton$OnVisibilityChangedListener;)Landroid/support/design/widget/b$d;
    .locals 1
...
.method private b()Landroid/support/design/widget/b;
    .locals 2
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/design/widget/c;-><init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/ShadowViewDelegate;)V
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/design/widget/b;-><init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/ShadowViewDelegate;)V

    return-object v0
.end method

.method private getImpl()Landroid/support/design/widget/b;
    .locals 1

    .line 1248
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->p:Landroid/support/design/widget/b;

    if-nez v0, :cond_0

    .line 1249
    invoke-direct {p0}, Landroid/support/design/widget/FloatingActionButton;->b()Landroid/support/design/widget/b;

    move-result-object v0

    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->p:Landroid/support/design/widget/b;
...
.method a(Landroid/support/design/widget/FloatingActionButton$OnVisibilityChangedListener;Z)V
    ...
    invoke-direct {p0, p1}, Landroid/support/design/widget/FloatingActionButton;->a(Landroid/support/design/widget/FloatingActionButton$OnVisibilityChangedListener;)Landroid/support/design/widget/b$d;

    move-result-object p1

    invoke-virtual {v0, p1, p2}, Landroid/support/design/widget/b;->b(Landroid/support/design/widget/b$d;Z)V
...
.method public addOnHideAnimationListener(Landroid/animation/Animator$AnimatorListener;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/b;->c(Landroid/animation/Animator$AnimatorListener;)V
...
.method public addOnShowAnimationListener(Landroid/animation/Animator$AnimatorListener;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/b;->a(Landroid/animation/Animator$AnimatorListener;)V
...
.method b(Landroid/support/design/widget/FloatingActionButton$OnVisibilityChangedListener;Z)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/design/widget/b;->a(Landroid/support/design/widget/b$d;Z)V
...
.method public getCompatElevation()F
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/b;->a()F
...
.method public getCompatPressedTranslationZ()F
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/b;->c()F
...
.method public getContentBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/b;->h()Landroid/graphics/drawable/Drawable;
...
.method public getExpandedComponentIdHint()I
    ...
    .line 568
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->o:Landroid/support/design/expandable/ExpandableWidgetHelper;
...
.method public getHideMotionSpec()Landroid/support/design/animation/MotionSpec;
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/b;->f()Landroid/support/design/animation/MotionSpec;
...
.method public getShowMotionSpec()Landroid/support/design/animation/MotionSpec;
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/b;->e()Landroid/support/design/animation/MotionSpec;
...
.method public isOrWillBeHidden()Z
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/b;->s()Z
...
.method public isOrWillBeShown()Z
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/b;->r()Z
...
.method protected onAttachedToWindow()V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/b;->k()V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/b;->l()V
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {v1}, Landroid/support/design/widget/b;->j()V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v3, p0, Landroid/support/design/widget/FloatingActionButton;->o:Landroid/support/design/expandable/ExpandableWidgetHelper;
...
.method public removeOnHideAnimationListener(Landroid/animation/Animator$AnimatorListener;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/b;->d(Landroid/animation/Animator$AnimatorListener;)V
...
.method public removeOnShowAnimationListener(Landroid/animation/Animator$AnimatorListener;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/b;->b(Landroid/animation/Animator$AnimatorListener;)V
...
.method public setBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/b;->a(Landroid/graphics/PorterDuff$Mode;)V
...
.method public setCompatElevation(F)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/b;->a(F)V
...
.method public setCompatHoveredFocusedTranslationZ(F)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/b;->b(F)V
...
.method public setCompatPressedTranslationZ(F)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/b;->c(F)V
...
.method public setHideMotionSpec(Landroid/support/design/animation/MotionSpec;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/b;->b(Landroid/support/design/animation/MotionSpec;)V
...
.method public setRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/design/widget/b;->b(Landroid/content/res/ColorStateList;)V
...
.method public setShowMotionSpec(Landroid/support/design/animation/MotionSpec;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/design/widget/b;->a(Landroid/support/design/animation/MotionSpec;)V
...
.method public setUseCompatPadding(Z)V
    ...
    invoke-virtual {p1}, Landroid/support/design/widget/b;->i()V
