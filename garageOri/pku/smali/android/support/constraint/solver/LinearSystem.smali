...
.field final e:Landroid/support/constraint/solver/Cache;
...
.field private h:Landroid/support/constraint/solver/LinearSystem$a;
...
.field private final p:Landroid/support/constraint/solver/LinearSystem$a;
...
.method public constructor <init>()V
    ...
    .line 47
    iput-object v1, p0, Landroid/support/constraint/solver/LinearSystem;->g:Ljava/util/HashMap;

    const/16 v2, 0x20

    .line 54
    iput v2, p0, Landroid/support/constraint/solver/LinearSystem;->i:I

    .line 55
    iget v2, p0, Landroid/support/constraint/solver/LinearSystem;->i:I

    iput v2, p0, Landroid/support/constraint/solver/LinearSystem;->j:I
    ...
    iput-object v1, p0, Landroid/support/constraint/solver/LinearSystem;->k:[Z
    ...
    iput v1, p0, Landroid/support/constraint/solver/LinearSystem;->l:I

    .line 70
    sget v1, Landroid/support/constraint/solver/LinearSystem;->f:I

    new-array v1, v1, [Landroid/support/constraint/solver/SolverVariable;

    iput-object v1, p0, Landroid/support/constraint/solver/LinearSystem;->m:[Landroid/support/constraint/solver/SolverVariable;
    ...
    .line 80
    invoke-direct {p0}, Landroid/support/constraint/solver/LinearSystem;->b()V
    ...
    iput-object v0, p0, Landroid/support/constraint/solver/LinearSystem;->e:Landroid/support/constraint/solver/Cache;

    .line 82
    new-instance v0, Landroid/support/constraint/solver/GoalRow;

    iget-object v1, p0, Landroid/support/constraint/solver/LinearSystem;->e:Landroid/support/constraint/solver/Cache;

    invoke-direct {v0, v1}, Landroid/support/constraint/solver/GoalRow;-><init>(Landroid/support/constraint/solver/Cache;)V

    iput-object v0, p0, Landroid/support/constraint/solver/LinearSystem;->h:Landroid/support/constraint/solver/LinearSystem$a;
    ...
    iput-object v0, p0, Landroid/support/constraint/solver/LinearSystem;->p:Landroid/support/constraint/solver/LinearSystem$a;
...
.method private final a(Landroid/support/constraint/solver/LinearSystem$a;Z)I
    ...
    .line 564
    :goto_0
    iget v3, p0, Landroid/support/constraint/solver/LinearSystem;->c:I

    if-ge v2, v3, :cond_1

    .line 565
    iget-object v3, p0, Landroid/support/constraint/solver/LinearSystem;->k:[Z
    ...
    .line 585
    iget v4, p0, Landroid/support/constraint/solver/LinearSystem;->c:I
    ...
    .line 589
    :cond_3
    invoke-interface {p1}, Landroid/support/constraint/solver/LinearSystem$a;->getKey()Landroid/support/constraint/solver/SolverVariable;
    ...
    .line 590
    iget-object v4, p0, Landroid/support/constraint/solver/LinearSystem;->k:[Z
    ...
    invoke-interface {p1, p0, v4}, Landroid/support/constraint/solver/LinearSystem$a;->getPivotCandidate(Landroid/support/constraint/solver/LinearSystem;[Z)Landroid/support/constraint/solver/SolverVariable;
    ...
    .line 598
    iget-object v6, p0, Landroid/support/constraint/solver/LinearSystem;->k:[Z
    ...
    .line 622
    :goto_2
    iget v10, p0, Landroid/support/constraint/solver/LinearSystem;->d:I
    ...
    .line 625
    iget-object v11, v11, Landroid/support/constraint/solver/SolverVariable;->c:Landroid/support/constraint/solver/SolverVariable$Type;
    ...
    .line 629
    :cond_7
    iget-boolean v11, v10, Landroid/support/constraint/solver/ArrayRow;->d:Z
    ...
    iput v7, v6, Landroid/support/constraint/solver/SolverVariable;->a:I
    ...
    iput v8, v4, Landroid/support/constraint/solver/SolverVariable;->a:I
...
.method private a(Landroid/support/constraint/solver/SolverVariable$Type;Ljava/lang/String;)Landroid/support/constraint/solver/SolverVariable;
    ...
    .line 305
    iget-object v0, p0, Landroid/support/constraint/solver/LinearSystem;->e:Landroid/support/constraint/solver/Cache;

    iget-object v0, v0, Landroid/support/constraint/solver/Cache;->b:Landroid/support/constraint/solver/a$a;

    invoke-interface {v0}, Landroid/support/constraint/solver/a$a;->a()Ljava/lang/Object;
    ...
    .line 313
    :goto_0
    iget p1, p0, Landroid/support/constraint/solver/LinearSystem;->n:I

    sget p2, Landroid/support/constraint/solver/LinearSystem;->f:I

    if-lt p1, p2, :cond_1

    .line 314
    sget p1, Landroid/support/constraint/solver/LinearSystem;->f:I

    mul-int/lit8 p1, p1, 0x2

    sput p1, Landroid/support/constraint/solver/LinearSystem;->f:I

    .line 315
    iget-object p1, p0, Landroid/support/constraint/solver/LinearSystem;->m:[Landroid/support/constraint/solver/SolverVariable;
    ...
    iput-object p1, p0, Landroid/support/constraint/solver/LinearSystem;->m:[Landroid/support/constraint/solver/SolverVariable;

    .line 317
    :cond_1
    iget-object p1, p0, Landroid/support/constraint/solver/LinearSystem;->m:[Landroid/support/constraint/solver/SolverVariable;

    iget p2, p0, Landroid/support/constraint/solver/LinearSystem;->n:I
...
.method private a()V
    ...
    iput-object v0, p0, Landroid/support/constraint/solver/LinearSystem;->k:[Z
    ...
    iget v3, p0, Landroid/support/constraint/solver/LinearSystem;->i:I
...
.method private b(Landroid/support/constraint/solver/LinearSystem$a;)I
    ...
    .line 713
    :goto_0
    iget v3, v0, Landroid/support/constraint/solver/LinearSystem;->d:I
    ...
    .line 715
    iget-object v3, v3, Landroid/support/constraint/solver/SolverVariable;->c:Landroid/support/constraint/solver/SolverVariable$Type;
    ...
    .line 748
    :goto_4
    iget v14, v0, Landroid/support/constraint/solver/LinearSystem;->d:I
    ...
    .line 751
    iget-object v15, v15, Landroid/support/constraint/solver/SolverVariable;->c:Landroid/support/constraint/solver/SolverVariable$Type;
    ...
    .line 764
    :goto_5
    iget v15, v0, Landroid/support/constraint/solver/LinearSystem;->c:I

    if-ge v1, v15, :cond_b

    .line 765
    iget-object v15, v0, Landroid/support/constraint/solver/LinearSystem;->e:Landroid/support/constraint/solver/Cache;
    ...
    .line 774
    iget-object v7, v15, Landroid/support/constraint/solver/SolverVariable;->b:[F
    ...
    iput v9, v4, Landroid/support/constraint/solver/SolverVariable;->a:I
    ...
    .line 797
    :cond_d
    iget-object v4, v0, Landroid/support/constraint/solver/LinearSystem;->e:Landroid/support/constraint/solver/Cache;
    ...
    iput v10, v4, Landroid/support/constraint/solver/SolverVariable;->a:I
    ...
    .line 808
    :goto_9
    iget v1, v0, Landroid/support/constraint/solver/LinearSystem;->c:I
...
.method private b()V
    ...
    .line 132
    iget-object v2, p0, Landroid/support/constraint/solver/LinearSystem;->e:Landroid/support/constraint/solver/Cache;

    iget-object v2, v2, Landroid/support/constraint/solver/Cache;->a:Landroid/support/constraint/solver/a$a;

    invoke-interface {v2, v1}, Landroid/support/constraint/solver/a$a;->a(Ljava/lang/Object;)Z
...
.method private final b(Landroid/support/constraint/solver/ArrayRow;)V
    ...
    .line 451
    iput-boolean v0, p1, Landroid/support/constraint/solver/ArrayRow;->d:Z
...
.method private final c(Landroid/support/constraint/solver/ArrayRow;)V
    ...
    iget-object v0, v0, Landroid/support/constraint/solver/Cache;->a:Landroid/support/constraint/solver/a$a;
    ...
    invoke-interface {v0, v1}, Landroid/support/constraint/solver/a$a;->a(Ljava/lang/Object;)Z
...
.method private d()V
    ...
    iget v1, p0, Landroid/support/constraint/solver/LinearSystem;->c:I
...
.method a(Landroid/support/constraint/solver/ArrayRow;II)V
    ...
    .line 259
    invoke-virtual {p1, p3, p2}, Landroid/support/constraint/solver/ArrayRow;->b(Landroid/support/constraint/solver/SolverVariable;I)Landroid/support/constraint/solver/ArrayRow;
...
.method a(Landroid/support/constraint/solver/LinearSystem$a;)V
    ...
    .line 440
    invoke-direct {p0}, Landroid/support/constraint/solver/LinearSystem;->c()V
...
.method public addConstraint(Landroid/support/constraint/solver/ArrayRow;)V
    ...
    .line 466
    iget-boolean v0, p1, Landroid/support/constraint/solver/ArrayRow;->d:Z
    ...
    iget v4, p0, Landroid/support/constraint/solver/LinearSystem;->j:I

    if-lt v0, v4, :cond_3

    .line 471
    :cond_2
    invoke-direct {p0}, Landroid/support/constraint/solver/LinearSystem;->a()V

    :cond_3
    const/4 v0, 0x0

    .line 478
    iget-boolean v4, p1, Landroid/support/constraint/solver/ArrayRow;->d:Z
    ...
    .line 500
    iget-object v4, p0, Landroid/support/constraint/solver/LinearSystem;->p:Landroid/support/constraint/solver/LinearSystem$a;

    invoke-interface {v4, p1}, Landroid/support/constraint/solver/LinearSystem$a;->initFromRow(Landroid/support/constraint/solver/LinearSystem$a;)V
    ...
    .line 502
    iget v4, v0, Landroid/support/constraint/solver/SolverVariable;->a:I
...
.method public addEquality(Landroid/support/constraint/solver/SolverVariable;I)V
    ...
    .line 1149
    iget-boolean v1, v0, Landroid/support/constraint/solver/ArrayRow;->d:Z
    ...
    .line 1153
    iput-boolean p1, v0, Landroid/support/constraint/solver/ArrayRow;->d:Z
...
.method public createErrorVariable(ILjava/lang/String;)Landroid/support/constraint/solver/SolverVariable;
    ...
    iget v1, p0, Landroid/support/constraint/solver/LinearSystem;->j:I
    ...
    .line 294
    iget-object p1, p0, Landroid/support/constraint/solver/LinearSystem;->e:Landroid/support/constraint/solver/Cache;
    ...
    .line 295
    iget-object p1, p0, Landroid/support/constraint/solver/LinearSystem;->h:Landroid/support/constraint/solver/LinearSystem$a;

    invoke-interface {p1, p2}, Landroid/support/constraint/solver/LinearSystem$a;->addError(Landroid/support/constraint/solver/SolverVariable;)V
...
.method public createObjectVariable(Ljava/lang/Object;)Landroid/support/constraint/solver/SolverVariable;
    ...
    iget v2, p0, Landroid/support/constraint/solver/LinearSystem;->j:I
    ...
    .line 190
    iget p1, p0, Landroid/support/constraint/solver/LinearSystem;->c:I

    add-int/lit8 p1, p1, 0x1

    iput p1, p0, Landroid/support/constraint/solver/LinearSystem;->c:I
    ...
    iput-object p1, v0, Landroid/support/constraint/solver/SolverVariable;->c:Landroid/support/constraint/solver/SolverVariable$Type;
...
.method public displayVariablesReadableRows()V
    ...
    .line 884
    invoke-direct {p0}, Landroid/support/constraint/solver/LinearSystem;->d()V
    ...
    iget-object v2, v2, Landroid/support/constraint/solver/ArrayRow;->a:Landroid/support/constraint/solver/SolverVariable;

    iget-object v2, v2, Landroid/support/constraint/solver/SolverVariable;->c:Landroid/support/constraint/solver/SolverVariable$Type;
    ...
    invoke-virtual {v0}, Landroid/support/constraint/solver/ArrayRow;->b()Ljava/lang/String;
    ...
    iget-object v0, p0, Landroid/support/constraint/solver/LinearSystem;->h:Landroid/support/constraint/solver/LinearSystem$a;
...
.method public getMemoryUsed()I
    ...
    invoke-virtual {v2}, Landroid/support/constraint/solver/ArrayRow;->c()I
...
.method public minimize()V
    ...
    .line 390
    iget-boolean v4, v4, Landroid/support/constraint/solver/ArrayRow;->d:Z
...
.method public reset()V
    ...
    iget-object v1, v1, Landroid/support/constraint/solver/Cache;->b:Landroid/support/constraint/solver/a$a;
    ...
    .line 152
    iget-object v1, p0, Landroid/support/constraint/solver/LinearSystem;->g:Ljava/util/HashMap;
    ...
    .line 156
    iget-object v1, p0, Landroid/support/constraint/solver/LinearSystem;->h:Landroid/support/constraint/solver/LinearSystem$a;
