...
.method private a(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
    ...
    .line 177
    sget-object v0, Landroid/support/transition/ChangeImageTransform;->j:Landroid/util/Property;

    sget-object v1, Landroid/support/transition/ChangeImageTransform;->i:Landroid/animation/TypeEvaluator;
...
.method private a(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    ...
    new-instance v1, Landroid/support/transition/n$a;

    invoke-direct {v1}, Landroid/support/transition/n$a;-><init>()V
...
.method public createAnimator(Landroid/view/ViewGroup;Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    .line 162
    sget-object p2, Landroid/support/transition/h;->a:Landroid/graphics/Matrix;

    :cond_7
    if-nez v2, :cond_8

    .line 165
    sget-object v2, Landroid/support/transition/h;->a:Landroid/graphics/Matrix;

    .line 167
    :cond_8
    sget-object p3, Landroid/support/transition/ChangeImageTransform;->j:Landroid/util/Property;
    ...
    :cond_9
    :goto_1
    invoke-direct {p0, p1}, Landroid/support/transition/ChangeImageTransform;->a(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
