...
.field h:Landroid/support/transition/TransitionPropagation;
...
.field private v:Landroid/support/transition/o;

.field private w:Landroid/support/transition/o;
...
.method public constructor <init>()V
    ...
    invoke-direct {v1}, Landroid/support/transition/o;-><init>()V

    iput-object v1, p0, Landroid/support/transition/Transition;->v:Landroid/support/transition/o;
    ...
    iput-object v1, p0, Landroid/support/transition/Transition;->w:Landroid/support/transition/o;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 275
    sget-object v0, Landroid/support/transition/m;->c:[I
...
.method private a(Landroid/support/transition/o;Landroid/support/transition/o;)V
    .locals 5

    .line 664
    new-instance v0, Landroid/support/v4/util/ArrayMap;

    iget-object v1, p1, Landroid/support/transition/o;->a:Landroid/support/v4/util/ArrayMap;
    ...
    iget-object v2, p2, Landroid/support/transition/o;->a:Landroid/support/v4/util/ArrayMap;
    ...
    .line 681
    :pswitch_0
    iget-object v3, p1, Landroid/support/transition/o;->c:Landroid/support/v4/util/LongSparseArray;

    iget-object v4, p2, Landroid/support/transition/o;->c:Landroid/support/v4/util/LongSparseArray;
    ...
    .line 677
    :pswitch_1
    iget-object v3, p1, Landroid/support/transition/o;->b:Landroid/util/SparseArray;

    iget-object v4, p2, Landroid/support/transition/o;->b:Landroid/util/SparseArray;
    ...
    .line 673
    :pswitch_2
    iget-object v3, p1, Landroid/support/transition/o;->d:Landroid/support/v4/util/ArrayMap;

    iget-object v4, p2, Landroid/support/transition/o;->d:Landroid/support/v4/util/ArrayMap;
...
.method private static a(Landroid/support/transition/o;Landroid/view/View;Landroid/support/transition/TransitionValues;)V
    .locals 3

    .line 1531
    iget-object v0, p0, Landroid/support/transition/o;->a:Landroid/support/v4/util/ArrayMap;
    ...
    .line 1534
    iget-object v1, p0, Landroid/support/transition/o;->b:Landroid/util/SparseArray;
    ...
    .line 1543
    iget-object v1, p0, Landroid/support/transition/o;->d:Landroid/support/v4/util/ArrayMap;
    ...
    .line 1555
    iget-object p2, p0, Landroid/support/transition/o;->c:Landroid/support/v4/util/LongSparseArray;
    ...
    .line 1557
    iget-object p1, p0, Landroid/support/transition/o;->c:Landroid/support/v4/util/LongSparseArray;
    ...
    .line 1560
    iget-object p0, p0, Landroid/support/transition/o;->c:Landroid/support/v4/util/LongSparseArray;
...
.method private b(Landroid/view/View;Z)V
    ...
    .line 1627
    iget-object v3, p0, Landroid/support/transition/Transition;->v:Landroid/support/transition/o;

    invoke-static {v3, p1, v1}, Landroid/support/transition/Transition;->a(Landroid/support/transition/o;Landroid/view/View;Landroid/support/transition/TransitionValues;)V

    goto :goto_2

    .line 1629
    :cond_6
    iget-object v3, p0, Landroid/support/transition/Transition;->w:Landroid/support/transition/o;
...
.method a(Landroid/support/transition/TransitionValues;)V
    ...
    .line 2180
    iget-object v0, p0, Landroid/support/transition/Transition;->h:Landroid/support/transition/TransitionPropagation;
...
.method a(Landroid/view/ViewGroup;)V
    ...
    .line 1783
    iget-object v0, p0, Landroid/support/transition/Transition;->v:Landroid/support/transition/o;

    iget-object v1, p0, Landroid/support/transition/Transition;->w:Landroid/support/transition/o;

    invoke-direct {p0, v0, v1}, Landroid/support/transition/Transition;->a(Landroid/support/transition/o;Landroid/support/transition/o;)V
    ...
    .line 1787
    invoke-static {p1}, Landroid/support/transition/aa;->b(Landroid/view/View;)Landroid/support/transition/ah;
    ...
    iget-object v6, v5, Landroid/support/transition/Transition$a;->d:Landroid/support/transition/ah;
    ...
    .line 1817
    :cond_5
    iget-object v6, p0, Landroid/support/transition/Transition;->v:Landroid/support/transition/o;

    iget-object v7, p0, Landroid/support/transition/Transition;->w:Landroid/support/transition/o;
    ...
    invoke-virtual/range {v4 .. v9}, Landroid/support/transition/Transition;->createAnimators(Landroid/view/ViewGroup;Landroid/support/transition/o;Landroid/support/transition/o;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
...
.method a(Landroid/view/ViewGroup;Z)V
    ...
    .line 1486
    iget-object v4, p0, Landroid/support/transition/Transition;->v:Landroid/support/transition/o;

    invoke-static {v4, v2, v3}, Landroid/support/transition/Transition;->a(Landroid/support/transition/o;Landroid/view/View;Landroid/support/transition/TransitionValues;)V

    goto :goto_3

    .line 1488
    :cond_5
    iget-object v4, p0, Landroid/support/transition/Transition;->w:Landroid/support/transition/o;
    ...
    invoke-static {v3, v0, v2}, Landroid/support/transition/Transition;->a(Landroid/support/transition/o;Landroid/view/View;Landroid/support/transition/TransitionValues;)V
    ...
    iget-object v3, v3, Landroid/support/transition/o;->d:Landroid/support/v4/util/ArrayMap;
...
.method a(Z)V
    ...
    .line 1577
    iget-object p1, p0, Landroid/support/transition/Transition;->v:Landroid/support/transition/o;

    iget-object p1, p1, Landroid/support/transition/o;->a:Landroid/support/v4/util/ArrayMap;
    ...
    iget-object p1, p1, Landroid/support/transition/o;->b:Landroid/util/SparseArray;
    ...
    iget-object p1, p1, Landroid/support/transition/o;->c:Landroid/support/v4/util/LongSparseArray;
    ...
    .line 1581
    :cond_0
    iget-object p1, p0, Landroid/support/transition/Transition;->w:Landroid/support/transition/o;
...
.method b(Landroid/view/ViewGroup;)V
    ...
    iget-object v2, v2, Landroid/support/transition/Transition$a;->d:Landroid/support/transition/ah;
...
.method b(Z)V
    ...
    .line 2204
    iput-boolean p1, p0, Landroid/support/transition/Transition;->f:Z
...
.method c(Landroid/view/ViewGroup;)Landroid/support/transition/Transition;
    ...
    .line 2199
    iput-object p1, p0, Landroid/support/transition/Transition;->B:Landroid/view/ViewGroup;
...
.method public clone()Landroid/support/transition/Transition;
    ...
    .line 2217
    new-instance v2, Landroid/support/transition/o;

    invoke-direct {v2}, Landroid/support/transition/o;-><init>()V

    iput-object v2, v1, Landroid/support/transition/Transition;->v:Landroid/support/transition/o;
    ...
    iput-object v2, v1, Landroid/support/transition/Transition;->w:Landroid/support/transition/o;
...
.method protected createAnimators(Landroid/view/ViewGroup;Landroid/support/transition/o;Landroid/support/transition/o;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    .locals 20
    .annotation build Landroid/support/annotation/RestrictTo;
        value = {
            .enum Landroid/support/annotation/RestrictTo$Scope;->LIBRARY_GROUP:Landroid/support/annotation/RestrictTo$Scope;
    ...
    .line 755
    iget-object v5, v10, Landroid/support/transition/o;->a:Landroid/support/v4/util/ArrayMap;
    ...
    .line 780
    iget-object v4, v6, Landroid/support/transition/Transition;->h:Landroid/support/transition/TransitionPropagation;
    ...
    .line 786
    invoke-static/range {p1 .. p1}, Landroid/support/transition/aa;->b(Landroid/view/View;)Landroid/support/transition/ah;
    ...
    invoke-direct/range {v0 .. v5}, Landroid/support/transition/Transition$a;-><init>(Landroid/view/View;Ljava/lang/String;Landroid/support/transition/Transition;Landroid/support/transition/ah;Landroid/support/transition/TransitionValues;)V
...
.method protected end()V
    ...
    iget-object v3, v3, Landroid/support/transition/o;->c:Landroid/support/v4/util/LongSparseArray;
...
.method public excludeChildren(IZ)Landroid/support/transition/Transition;
    ...
    iput-object p1, p0, Landroid/support/transition/Transition;->s:Ljava/util/ArrayList;
...
.method public excludeChildren(Landroid/view/View;Z)Landroid/support/transition/Transition;
    ...
    iput-object p1, p0, Landroid/support/transition/Transition;->t:Ljava/util/ArrayList;
...
.method public excludeChildren(Ljava/lang/Class;Z)Landroid/support/transition/Transition;
    ...
    iput-object p1, p0, Landroid/support/transition/Transition;->u:Ljava/util/ArrayList;
...
.method public getTransitionValues(Landroid/view/View;Z)Landroid/support/transition/TransitionValues;
    ...
    .line 1666
    iget-object p2, p0, Landroid/support/transition/Transition;->v:Landroid/support/transition/o;

    goto :goto_0

    :cond_1
    iget-object p2, p0, Landroid/support/transition/Transition;->w:Landroid/support/transition/o;

    .line 1667
    :goto_0
    iget-object p2, p2, Landroid/support/transition/o;->a:Landroid/support/v4/util/ArrayMap;
...
.method public pause(Landroid/view/View;)V
    ...
    iget-object v3, v3, Landroid/support/transition/Transition$a;->d:Landroid/support/transition/ah;
...
.method public setPropagation(Landroid/support/transition/TransitionPropagation;)V
    ...
    .line 2155
    iput-object p1, p0, Landroid/support/transition/Transition;->h:Landroid/support/transition/TransitionPropagation;
